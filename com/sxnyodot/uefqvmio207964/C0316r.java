...
final class C0316r implements Runnable {
    private static final String METHOD_GET = "GET";
    private static final String METHOD_POST = "POST";
    private final String f419a;
    private final String[] f420b;
    private boolean f421c;
    private C0292b<String> f422d;

    public C0316r(String str, String str2, C0292b<String> c0292b) {
        this.f421c = false;
        this.f419a = str;
    ...
    public C0316r(String str, String... strArr) {
        this.f421c = false;
        this.f419a = str;
        this.f420b = strArr;
        this.f421c = false;
    ...
    public synchronized void run() {
        try {
            ...
            Log.e(C0300h.TAG, "Error in tracker: ", e);
        }
    }
        ...
        if (str != null) {
            ...
            try {
                if (str.length() != 0) {
                    ...
                    httpURLConnection.setRequestProperty("connection", C0303k.EVENT_CLOSE);
                    ...
                    if (httpURLConnection != null) {
                        try {
                            ...
                            try {
                                ...
                                Log.e(C0300h.TAG, "Error occurred while firing trackers", th3);
                            }
                            if (this.f422d == null) {
    ...
    private void m1041a() {
        ...
        try {
            if (this.f420b == null || this.f420b.length == 0) {
                Log.w(C0300h.TAG, "Trackers null");
                return;
            }
            int i = 0;
            while (i < this.f420b.length) {
                try {
                    if (this.f420b[i] == null || this.f420b[i].length() == 0) {
                        Log.w(C0300h.TAG, "Param null");
                        i++;
                    } else {
                        Log.i(C0300h.TAG, "Beacon: " + this.f420b[i]);
                        ...
                        if (responseCode == 200) {
                            ...
                            bufferedReader.close();
                            Log.i(C0300h.TAG, "Beacon Data: " + stringBuffer.toString());
                        } else {
                            Log.i(C0300h.TAG, "Error reason: " + httpURLConnection.getResponseMessage());
                        }
                        if (httpURLConnection != null) {
                            httpURLConnection.disconnect();
                        }
            ...
            Log.e(C0300h.TAG, "Error occurred while firing trackers", e2);
        }
    }
}
