...
final class C0291a extends AsyncTask<Void, Void, Boolean> {
    private static boolean f366c;
    private final String f367a;
    private final Context f368b;
    private final C0292b<Boolean> f369d;
    ...
    public C0291a(Context context, C0292b<Boolean> c0292b) {
        this.f367a = C0300h.TAG;
        this.f368b = context;
        this.f369d = c0292b;
    }
    ...
    protected Boolean m1002a(Void... voidArr) {
        ...
        try {
            ...
            try {
                ...
                e = e2;
                Log.w(C0300h.TAG, "IOException", e);
                return Boolean.valueOf(z);
            } catch (GooglePlayServicesNotAvailableException e3) {
                e = e3;
                Log.w(C0300h.TAG, "GooglePlayServicesNotAvailableException", e);
                return Boolean.valueOf(z);
            } catch (IllegalStateException e4) {
                e = e4;
                Log.w(C0300h.TAG, "IllegalStateException", e);
                return Boolean.valueOf(z);
            } catch (GooglePlayServicesRepairableException e5) {
                e = e5;
                Log.w(C0300h.TAG, "GooglePlayServicesRepairableException", e);
                return Boolean.valueOf(z);
            } catch (Exception e6) {
                e = e6;
                Log.w(C0300h.TAG, "Exception occurred while fetching advertiser id", e);
                return Boolean.valueOf(z);
            }
        } catch (Throwable e7) {
            th = e7;
