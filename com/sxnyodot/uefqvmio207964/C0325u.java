...
abstract class C0325u extends Activity {
    ...
    static class C03211 implements Runnable {
        ...
        public void run() {
            try {
                Log.i(C0325u.TAG, "Sending vast event:" + this.f431a);
                Util.m929a("URL: " + this.f431a);
                DefaultHttpClient defaultHttpClient = new DefaultHttpClient();
                defaultHttpClient.getParams().setParameter("http.useragent", C0325u.f460F);
                ...
                Log.i(C0325u.TAG, "Status code: " + statusCode);
                if (statusCode == 200) {
                    Log.i(C0325u.TAG, "VAST Data: " + EntityUtils.toString(execute.getEntity()));
                } else {
                    Log.i(C0325u.TAG, "Error reason: " + execute.getStatusLine().getReasonPhrase());
                }
            } catch (Throwable e) {
                Log.e(C0325u.TAG, "Exception: ", e);
            }
        }
    }
    ...
    class C03222 implements Runnable {
        final /* synthetic */ C0325u f432a;

        C03222(C0325u c0325u) {
            this.f432a = c0325u;
        }

        public void run() {
            try {
                String decodeString = Base64.decodeString(C0300h.URL_VAST_EVENT_API);
                ...
                Log.i(C0325u.TAG, "Sending vast event:" + arrayList);
                ...
                Log.i(C0325u.TAG, "Status code: " + statusCode);
                if (statusCode == 200) {
                    Log.i(C0325u.TAG, "Vast impression: " + EntityUtils.toString(execute.getEntity()));
                } else {
                    Log.i(C0325u.TAG, "Error reason: " + execute.getStatusLine().getReasonPhrase());
                }
            } catch (Throwable e) {
    ...
    static /* synthetic */ class C03233 {
        static final /* synthetic */ int[] f433a;

        static {
            f433a = new int[C0324a.values().length];
            try {
                f433a[C0324a.AdImpression.ordinal()] = 1;
            } catch (NoSuchFieldError e) {
            }
            try {
                f433a[C0324a.AdClickThru.ordinal()] = 2;
            } catch (NoSuchFieldError e2) {
            }
            try {
                f433a[C0324a.AdVideoComplete.ordinal()] = 3;
            } catch (NoSuchFieldError e3) {
            }
            try {
                f433a[C0324a.AdSkipped.ordinal()] = 4;
            } catch (NoSuchFieldError e4) {
            }
            try {
                f433a[C0324a.AdPaused.ordinal()] = 5;
            } catch (NoSuchFieldError e5) {
            }
            try {
                f433a[C0324a.AdPlaying.ordinal()] = 6;
            } catch (NoSuchFieldError e6) {
            }
            try {
                f433a[C0324a.AdVideoStart.ordinal()] = 7;
            } catch (NoSuchFieldError e7) {
            }
            try {
                f433a[C0324a.AdVideoFirstQuartile.ordinal()] = 8;
            } catch (NoSuchFieldError e8) {
            }
            try {
                f433a[C0324a.AdVideoMidpoint.ordinal()] = 9;
            } catch (NoSuchFieldError e9) {
            }
            try {
                f433a[C0324a.AdVideoThirdQuartile.ordinal()] = 10;
            } catch (NoSuchFieldError e10) {
            }
            try {
                f433a[C0324a.AdLoaded.ordinal()] = 11;
            } catch (NoSuchFieldError e11) {
            }
            try {
                f433a[C0324a.AdVolumeChange.ordinal()] = 12;
            } catch (NoSuchFieldError e12) {
            }
            try {
                f433a[C0324a.AdUserClose.ordinal()] = 13;
    ...
    void m1062a(C0324a c0324a) {
        switch (C03233.f433a[c0324a.ordinal()]) {
            ...
            case DetectedActivity.STILL /*3*/:
                this.f469d.add(new BasicNameValuePair(C0303k.EVENT_COMPLETE, "1"));
                m1052d(C0303k.EVENT_COMPLETE);
            case DetectedActivity.UNKNOWN /*4*/:
                this.f469d.add(new BasicNameValuePair(C0303k.EVENT_SKIP, "1"));
                m1052d(C0303k.EVENT_SKIP);
            case DetectedActivity.TILTING /*5*/:
                this.f469d.add(new BasicNameValuePair(C0303k.EVENT_PAUSE, "1"));
                m1052d(C0303k.EVENT_PAUSE);
            case GamesClient.STATUS_NETWORK_ERROR_OPERATION_FAILED /*6*/:
                this.f469d.add(new BasicNameValuePair(C0303k.EVENT_RESUME, "1"));
                m1052d(C0303k.EVENT_RESUME);
            case GamesClient.STATUS_LICENSE_CHECK_FAILED /*7*/:
                this.f469d.add(new BasicNameValuePair(C0303k.EVENT_START, "1"));
                m1052d(C0303k.EVENT_START);
            case GamesClient.STATUS_APP_MISCONFIGURED /*8*/:
                this.f469d.add(new BasicNameValuePair(C0303k.EVENT_FIRST_QUARTILE, "1"));
                m1052d(C0303k.EVENT_FIRST_QUARTILE);
            case ConnectionResult.SERVICE_INVALID /*9*/:
                this.f469d.add(new BasicNameValuePair(C0303k.EVENT_MID_POINT, "1"));
                m1052d(C0303k.EVENT_MID_POINT);
            case ConnectionResult.DEVELOPER_ERROR /*10*/:
                this.f469d.add(new BasicNameValuePair(C0303k.EVENT_THIRD_QUARTILE, "1"));
                m1052d(C0303k.EVENT_THIRD_QUARTILE);
            case ConnectionResult.LICENSE_CHECK_FAILED /*11*/:
                this.f469d.add(new BasicNameValuePair(C0303k.EVENT_CREATIVE_VIEW, "1"));
                m1052d(C0303k.EVENT_CREATIVE_VIEW);
            case ConnectionResult.DATE_INVALID /*12*/:
                if (this.f465D == 0) {
                    this.f469d.add(new BasicNameValuePair(C0303k.EVENT_MUTE, "1"));
                    m1052d(C0303k.EVENT_MUTE);
                    return;
                }
                this.f469d.add(new BasicNameValuePair(C0303k.EVENT_UNMUTE, "1"));
                m1052d(C0303k.EVENT_UNMUTE);
            case C0048R.styleable.MapAttrs_zOrderOnTop /*13*/:
                this.f469d.add(new BasicNameValuePair(C0303k.EVENT_CLOSE, "1"));
                m1052d(C0303k.EVENT_CLOSE);
            default:
        }
    }

    private static synchronized void m1051a(String str) {
        synchronized (C0325u.class) {
            synchronized (str) {
                if (Util.m977o(f461c)) {
                    new Thread(new C03211(str), "vast_event").start();
                }
            }
        }
    }
            ...
            if (this.f467a != null) {
                for (HashMap hashMap : this.f467a.m1676f()) {
                    synchronized (hashMap) {
                        String str = (String) hashMap.get(C0303k.IMPRESSION);
                        Log.i(TAG, "Sending impression data: " + ((String) hashMap.get(C0303k.ID)));
            ...
            if (this.f468b != null) {
                try {
                    for (HashMap hashMap : this.f468b.getVideoClickTracking()) {
                        String str = (String) hashMap.get(C0303k.CLICK_TRACKING);
                        Log.i(TAG, "Sending click data: " + ((String) hashMap.get(C0303k.ID)));
                        if (str == null || str.equals("")) {
                ...
                for (HashMap hashMap2 : this.f468b.getVideoCustomClickTracking()) {
                    Log.i(TAG, "Sending cutom click data: " + ((String) hashMap2.get(C0303k.ID)));
                    String str2 = (String) hashMap2.get(C0303k.CUSTOM_CLICK);
    ...
    void m1087n() {
        ...
        try {
            ...
            synchronized (this.f469d) {
                if (Util.m977o(f461c)) {
                    new Thread(new C03222(this), "vast_report").start();
                    return;
                }
            }
        } catch (Throwable e2) {
