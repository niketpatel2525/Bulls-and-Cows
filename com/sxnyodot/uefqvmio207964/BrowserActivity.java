...
public class BrowserActivity extends Activity implements OnClickListener {
    ...
    class C02491 extends Handler {
        ...
        C02491(BrowserActivity browserActivity) {
    ...
    class BrowserView extends WebView {
        ...
        class C02501 extends WebChromeClient {
            final /* synthetic */ BrowserActivity f158a;
            final /* synthetic */ Activity f159b;
            final /* synthetic */ BrowserView f160c;

            C02501(BrowserView browserView, BrowserActivity browserActivity, Activity activity) {
        ...
        class C02512 extends WebViewClient {
            final /* synthetic */ BrowserActivity f161a;
            final /* synthetic */ BrowserView f162b;

            C02512(BrowserView browserView, BrowserActivity browserActivity) {
        ...
        public BrowserView(BrowserActivity browserActivity, Context context, String url) {
            ...
            m877a();
            m876b();
            setWebChromeClient(new C02501(this, browserActivity, browserActivity));
            setWebViewClient(new C02512(this, browserActivity));
        }
    }

    public BrowserActivity() {
        this.f164a = new C02491(this);
    }
    ...
    L_0x00a9:
        r0 = com.sxnyodot.uefqvmio207964.MV.f622a;	 Catch:{ ActivityNotFoundException -> 0x00bd, Exception -> 0x00e1, Throwable -> 0x007c }
    ...
    L_0x00bd:
        ...
        r0 = com.sxnyodot.uefqvmio207964.MV.f622a;	 Catch:{ Exception -> 0x003f, Throwable -> 0x007c }
        r1 = "error";
    ...
    L_0x00e1:
        r0 = move-exception;
        r1 = com.sxnyodot.uefqvmio207964.MV.f622a;	 Catch:{ Exception -> 0x003f, Throwable -> 0x007c }
        r2 = "error";
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == CALENDER_CREATE_EVENT_REQUEST_CODE) {
            if (resultCode == -1) {
                try {
                    ...
                    MV.f622a.m2057d(IM.MRAID_EVENT_CREATE_CALENDER);
                    MV.f622a.m2051a(true);
                    finish();
                } catch (Exception e) {
                    return;
                }
        ...
        if (resultCode == -1) {
            ...
            MV.f622a.m2057d(IM.MRAID_EVENT_PLAY_VIDEO);
            MV.f622a.m2051a(true);
            finish();
        } else if (resultCode == 0) {
            MV.f622a.m2051a(true);
            MV.f622a.m2050a(INTENT_ACTION_PLAY_VIDEO, "Play video is canceled by user.");
            finish();
        } else {
            finish();
        }
