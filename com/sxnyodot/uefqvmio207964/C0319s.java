...
class C0319s {
    ...
    class C03171 implements LocationListener {
        final /* synthetic */ LocationManager f423a;
        final /* synthetic */ C0319s f424b;

        C03171(C0319s c0319s, LocationManager locationManager) {
            this.f424b = c0319s;
    ...
    private class C0318a {
        ...
        final /* synthetic */ C0319s f426b;

        public C0318a(C0319s c0319s, Context context) {
            this.f426b = c0319s;
            if (this.f425a == null) {
                synchronized (C0318a.class) {
                    if (this.f425a == null) {
                        ...
                        if (string != null) {
                            ...
                            string = Secure.getString(context.getContentResolver(), C0300h.ANDROID_ID);
                            try {
        ...
        try {
            ...
            if (deviceId == null || deviceId.equals("")) {
                ...
                if (this.f427a.getPackageManager().checkPermission("android.permission.ACCESS_WIFI_STATE", Util.m947e(this.f427a)) == 0) {
                    WifiManager wifiManager = (WifiManager) this.f427a.getSystemService(C0300h.WIFI);
                    System.out.println("WIFI " + wifiManager.isWifiEnabled());
                    deviceId = wifiManager.getConnectionInfo().getMacAddress();
                    Util.m968l("WIFI_MAC");
                    return deviceId;
                }
                deviceId = new C0318a(this, this.f427a).m1043a().toString();
                Util.m968l("UUID");
                return deviceId;
            }
            Util.m968l("IMEI");
    ...
    boolean m1047b() {
        ...
        try {
            String a = m1046a();
            if (a == null || a.equals("") || a.equals(C0300h.INVALID)) {
            ...
            Log.e(C0300h.TAG, "Error occured while converting details to md5." + e.getMessage());
        } catch (Exception e2) {
            e2.printStackTrace();
            Log.e(C0300h.TAG, "Error occured while converting details to md5.");
        }
    }
    ...
    private boolean m1045e() {
        try {
            ...
            Log.e(C0300h.TAG, "Error occured while converting details to SHA-1." + e.getMessage());
            return false;
        } catch (Exception e2) {
            e2.printStackTrace();
            Log.e(C0300h.TAG, "Error occured while converting details to SHA-1.");
            return false;
        }
    }
        ...
        try {
            ...
            synchronized (this.f427a) {
                ...
                if (obj == null || r3 == null) {
                    ...
                    Util.m928a(System.currentTimeMillis());
                    locationManager.requestLocationUpdates(bestProvider, 0, 0.0f, new C03171(this, locationManager), this.f427a.getMainLooper());
                }
                return this.f428b;
            }
        } catch (Exception e) {
            Log.w(C0300h.TAG, "Error occured while fetching location. " + e.getMessage());
        } catch (Throwable th) {
            Log.e(C0300h.TAG, "Error in location: " + th.getMessage());
        }
    }
}
