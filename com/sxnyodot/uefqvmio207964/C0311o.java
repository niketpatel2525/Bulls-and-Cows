...
class C0311o {
    ...
    class C03101 implements Runnable {
        ...
        final /* synthetic */ C0311o f414b;

        C03101(C0311o c0311o, int i) {
            this.f414b = c0311o;
            this.f413a = i;
        }
        ...
        public void run() {
            ...
            try {
                ...
                arrayList.add(new BasicNameValuePair(C0300h.PACKAGE_NAME, this.f414b.f415a.getPackageName()));
                ...
                Log.i(C0300h.TAG, "Error values: " + arrayList);
                HttpClient defaultHttpClient = new DefaultHttpClient();
                HttpUriRequest httpPost = new HttpPost(Base64.decodeString(C0300h.ERROR_URL));
                ...
                Log.i(C0300h.TAG, "Status code: " + i);
                if (i == 200) {
                    Log.i(C0300h.TAG, "Error sent: " + EntityUtils.toString(execute.getEntity()));
                    return;
                }
                Log.i(C0300h.TAG, "Status Code: " + i + ", Reason: " + execute.getStatusLine().getReasonPhrase());
    ...
    public C0311o(Context context, int i) {
        if (context != null) {
            this.f415a = context;
