...
public class MainActivity extends Activity {
    ...
    class C02771 extends Handler {
        ...
        C02771(MainActivity mainActivity) {
    ...
    class C02782 implements OnCancelListener {
        final /* synthetic */ MainActivity f293a;

        C02782(MainActivity mainActivity) {
    ...
    private class AppWall extends Dialog implements OnCancelListener, OnDismissListener {
        ...
        class C02791 extends WebViewClient {
            final /* synthetic */ MainActivity f294a;
            final /* synthetic */ AppWall f295b;

            C02791(AppWall appWall, MainActivity mainActivity) {
                this.f295b = appWall;
        ...
        public AppWall(MainActivity mainActivity, Context context, String url) {
            ...
            MainActivity.f298d.setWebViewClient(new C02791(this, mainActivity));
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            if (action.equals(INTENT_ACTION_RICH_MEDIA_FULL_PAGE_AD) && this.f302e.equalsIgnoreCase(C0300h.AD_TYPE_MFP)) {
                ...
                this.f300a.setOnCancelListener(new C02782(this));
            } else if (action.equals(INTENT_ACTION_APPWALL_AD) && this.f302e.equalsIgnoreCase(C0300h.AD_TYPE_AW)) {
                ...
                if (C0562q.m1751g(this)) {
                    f299i = true;
                    r1 = new C0559e(this, getIntent().getStringExtra("data"));
                ...
                if (this.f302e.equals("OLAU") || this.f302e.equals(C0300h.AD_TYPE_DAU) || this.f302e.equals(C0300h.AD_TYPE_DCC) || this.f302e.equals(C0300h.AD_TYPE_DCM)) {
                    this.f308l = AdType.overlay;
                    if (this.f307k == null) {
                        this.f307k = new C0309n(this);
                        return;
                    }
                    return;
                }
    ...
    protected void onUserLeaveHint() {
        try {
            if (this.f302e != null && (this.f302e.equals("OLAU") || this.f302e.equals(C0300h.AD_TYPE_DAU) || this.f302e.equals(C0300h.AD_TYPE_DCC) || this.f302e.equals(C0300h.AD_TYPE_DCM))) {
                if (this.f307k != null) {
                    this.f307k.dismiss();
                }
                finish();
    ...
    public void onBackPressed() {
        try {
            ...
            if (this.f302e != null && this.f302e.equals(C0300h.AD_TYPE_AW)) {
                if (this.f306j != null) {
                    this.f306j.dismiss();
                }
                if (this.f305h != null) {
                ...
                finish();
            } else if (this.f302e != null && this.f302e.equals(C0300h.AD_TYPE_MFP)) {
                if (this.f300a != null) {
                    this.f300a.dismiss();
                }
                finish();
