...
final class C0304m implements Runnable {
    private static final String ENCODING_GZIP = "gzip";
    private static final String HEADER_ACCEPT_ENCODING = "Accept-Encoding";
    private final Context f381a;
    private final C0292b<String> f382b;
    private final List<NameValuePair> f383c;
    private final String f384d;
    private final long f385e;
    private final boolean f386f;

    public C0304m(Context context, C0292b<String> c0292b, List<NameValuePair> list, String str, long j, boolean z) {
        this.f381a = context;
        this.f382b = c0292b;
        this.f383c = list;
    ...
    public void run() {
        ...
        try {
            if (this.f386f) {
                this.f383c.addAll(C0562q.m1744a(this.f381a));
            }
            ...
            if (Util.m977o(this.f381a)) {
                ...
                httpsURLConnection.setRequestProperty("connection", C0303k.EVENT_CLOSE);
                ...
                try {
                    ...
                    Log.i(C0300h.TAG, "Status code: " + responseCode);
                    if (responseCode == 200) {
                    ...
                    Log.i(C0300h.TAG, "Error reason: " + httpsURLConnection.getResponseMessage());
                    if (httpsURLConnection != null) {
                        httpsURLConnection.disconnect();
                    }
                } catch (Throwable e2) {
                    Log.w(C0300h.TAG, "SocketTimeoutException Thrown: ", e2);
                    if (httpsURLConnection != null) {
                        httpsURLConnection.disconnect();
                    }
                } catch (Throwable e22) {
                    Log.w(C0300h.TAG, "ClientProtocolException Thrown: ", e22);
                    if (httpsURLConnection != null) {
                        httpsURLConnection.disconnect();
                    }
                } catch (Throwable e222) {
                    Log.w(C0300h.TAG, "MalformedURLException Thrown: ", e222);
                    if (httpsURLConnection != null) {
                        httpsURLConnection.disconnect();
                    }
                } catch (Throwable e2222) {
                    Log.w(C0300h.TAG, "SSL Exception: ", e2222);
                    if (httpsURLConnection != null) {
                        httpsURLConnection.disconnect();
                    }
                } catch (Throwable e22222) {
                    Log.w(C0300h.TAG, "IOException Thrown: ", e22222);
                    if (httpsURLConnection != null) {
                        httpsURLConnection.disconnect();
                    }
                } catch (Throwable e222222) {
                    Log.w(C0300h.TAG, "Exception Thrown: ", e222222);
                    if (httpsURLConnection != null) {
                        httpsURLConnection.disconnect();
                    }
                } catch (Throwable th) {
            ...
            Log.w(C0300h.TAG, "Exception Thrown: " + e3.getMessage());
        }
