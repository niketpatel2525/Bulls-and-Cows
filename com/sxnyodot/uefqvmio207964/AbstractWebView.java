...
final class AbstractWebView extends WebView {
    ...
    class C02321 extends WebViewClient {
        final /* synthetic */ Handler f87a;
        final /* synthetic */ AbstractWebView f88b;

        C02321(AbstractWebView abstractWebView, Handler handler) {
    ...
    class C02332 implements Runnable {
        ...
        C02332(AbstractWebView abstractWebView) {
    ...
    class C02343 implements Runnable {
        ...
        C02343(AbstractWebView abstractWebView) {
    ...
    class C02354 implements Runnable {
        ...
        C02354(AbstractWebView abstractWebView) {
    ...
    class C02365 implements Runnable {
        ...
        C02365(AbstractWebView abstractWebView) {
    ...
    class C02376 implements OnClickListener {
        final /* synthetic */ int f93a;
        final /* synthetic */ String f94b;
        final /* synthetic */ AbstractWebView f95c;

        C02376(AbstractWebView abstractWebView, int i, String str) {
    ...
    class C02388 implements OnClickListener {
        final /* synthetic */ AbstractWebView f96a;

        C02388(AbstractWebView abstractWebView) {
    ...
    class C02399 implements Runnable {
        final /* synthetic */ AbstractWebView f97a;

        C02399(AbstractWebView abstractWebView) {
    ...
    static class C05477 implements C0292b<String> {
        final /* synthetic */ C0558c f498a;
        final /* synthetic */ int f499b;
        final /* synthetic */ String f500c;

        C05477(C0558c c0558c, int i, String str) {
            this.f498a = c0558c;
            this.f499b = i;
            this.f500c = str;
        }
        ...
        public void m1602a(String str) {
            Log.i(C0300h.TAG, "Banner Data: " + str);
            this.f498a.m1712b(this.f499b);
        }

        public void m1600a() {
            new Thread(new C0316r(Util.m964k(), this.f500c, this), "absimp").start();
        }
    }
    ...
    public AbstractWebView(Context context, int newWidth, int newHeight, Handler loadingListener, C0558c ad, boolean isTestMode, AbstractAdView adView) {
        super(context);
        this.f101c = IM.TAG;
        this.f102d = 0;
        this.f103e = 1;
        ...
        this.f99a = new Object() {
            ...
            class C02311 implements Runnable {
                ...
                C02311(AnonymousClass10 anonymousClass10) {
            ...
            public void addCloseButton() {
                this.f86a.post(new C02311(this));
            }
        };
        this.f100b = new C02332(this);
        f98l = false;
        ...
        try {
            ...
            setWebViewClient(new C02321(this, loadingListener));
            ...
            try {
                if (!str.equals("")) {
                    ...
                    if (this.f107i) {
                        ...
                        C0298f.m1015a(getContext(), str);
                        this.f105g.post(new C02343(this));
                        ...
                        C0298f.m1015a(getContext(), str);
                        this.f106h.m1712b(i);
                        this.f105g.post(new C02354(this));
                        if (this.f106h.m1701C() != null && this.f106h.m1701C().length > 0) {
                            new Thread(new C0316r(Util.m964k(), this.f106h.m1701C()), "cl").start();
    ...
    private void m825a(String str, String str2) {
        try {
            C0298f.m1016a(getContext(), str2, str);
            m835c();
        } catch (Throwable e) {
            Log.w(IM.TAG, e);
            m830b(89, getContext(), this.f106h);
    ...
    private synchronized void m829b() {
        try {
            ...
            if (this.f106h.m1700B() != null && this.f106h.m1700B().length > 0) {
                new Thread(new C0316r(Util.m964k(), this.f106h.m1700B()), "imp").start();
    ...
    private synchronized void m835c() {
        try {
            int i;
            this.f105g.post(new C02365(this));
            if (this.f106h.m1711b().equals("ABL")) {
                i = 29;
            } else if (this.f106h.m1711b().equals("ABS")) {
                i = 26;
    ...
    private void m822a(int i, String str) {
        if (this.f106h.m1704F() == 1) {
            ...
            button.setOnClickListener(new C02376(this, i, str));
    ...
    private static synchronized void m830b(int i, Context context, C0558c c0558c) {
            ...
            if (C0558c.m1698z()) {
                ...
                try {
                    if (Util.m977o(context)) {
                        if (c0558c.m1722k() || i != 89) {
                            Log.i(C0300h.TAG, "Sending banner event: ");
                            String a = c0558c.m1705a(i);
                            Util.m929a("event: " + i + " URL: " + a);
                            if (a == null || a.equals("")) {
                                Log.i(C0300h.TAG, "Event url null");
                            } else {
                                new C05477(c0558c, i, a).m1004a();
                            }
                        } else {
                    ...
                    Log.w(C0300h.TAG, "Exception: Sending banner event failed:" + e.getMessage());
    ...
    protected synchronized void m842a() {
        try {
            ...
            imageView.setOnClickListener(new C02388(this));
    ...
    private void m837d() {
        this.f105g.post(new C02399(this));
        if (this.f106h.m1711b().equals("ABL")) {
