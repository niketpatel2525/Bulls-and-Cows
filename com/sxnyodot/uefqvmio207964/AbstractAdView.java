...
final class AbstractAdView extends FrameLayout {
    ...
    class C02232 extends Handler {
        final /* synthetic */ AbstractAdView f49a;

        C02232(AbstractAdView abstractAdView) {
    ...
    class C02243 implements Runnable {
        ...
        C02243(AbstractAdView abstractAdView) {
    ...
    class C02275 implements Runnable {
        ...
        C02275(AbstractAdView abstractAdView) {
    ...
    class C02286 implements Runnable {
        ...
        C02286(AbstractAdView abstractAdView) {
    ...
    class C02297 extends TimerTask {
        final /* synthetic */ AbstractAdView f57a;

        C02297(AbstractAdView abstractAdView) {
    ...
    class C02308 extends TimerTask {
        final /* synthetic */ AbstractAdView f58a;

        C02308(AbstractAdView abstractAdView) {
    ...
    class C05451 implements C0248a {
        final /* synthetic */ AbstractAdView f496a;

        C05451(AbstractAdView abstractAdView) {
            this.f496a = abstractAdView;
        }

        public void m1596a() {
            this.f496a.f67g.sendEmptyMessage(2);
        }
    }

    /* renamed from: com.sxnyodot.uefqvmio207964.AbstractAdView.4 */
    class C05464 implements C0292b<String> {
        final /* synthetic */ AbstractAdView f497a;
        ...
        class C02251 implements Runnable {
            ...
            final /* synthetic */ C05464 f53c;

            C02251(C05464 c05464, int i, String str) {
                this.f53c = c05464;
                this.f51a = i;
                this.f52b = str;
            }
        ...
        class C02262 implements Runnable {
            final /* synthetic */ C05464 f54a;

            C02262(C05464 c05464) {
                this.f54a = c05464;
            }
        ...
        C05464(AbstractAdView abstractAdView) {
            this.f497a = abstractAdView;
        }

        public void m1597a() {
            this.f497a.f73m = true;
            List arrayList = new ArrayList();
            arrayList.add(new BasicNameValuePair("banner_type", this.f497a.f82v));
            arrayList.add(new BasicNameValuePair("supports", "" + Util.m985s(this.f497a.getContext())));
            if (this.f497a.f70j) {
                arrayList.add(new BasicNameValuePair("sdk_test", "1"));
            }
            arrayList.add(new BasicNameValuePair("placement_id", "" + this.f497a.f76p.m1699A()));
            try {
                this.f497a.f75o = new Thread(new C0304m(this.f497a.f68h, this, arrayList, C0300h.URL_IN_APP_AD_API, 0, true), "banner360");
                this.f497a.f75o.setPriority(10);
                this.f497a.f75o.start();
            } catch (Throwable e) {
        ...
        public void m1599a(String str) {
            try {
                Log.i(C0300h.TAG, "B360 json:" + str);
                this.f497a.f63c = System.currentTimeMillis();
                if (str == null || str.equals("")) {
                    this.f497a.post(new C02262(this));
                } else {
                    JSONObject jSONObject = new JSONObject(str);
                    String string = jSONObject.isNull("banner_type") ? "" : jSONObject.getString("banner_type");
                    if (string == null || string.equals("")) {
                        Log.i(C0300h.TAG, "No banner type present in response.");
                        ...
                        if (jSONObject.isNull(C0300h.TYPE_MESSAGE)) {
                            ...
                            string = jSONObject.getString(C0300h.TYPE_MESSAGE);
                        }
                        this.f497a.post(new C02251(this, i, string));
                        return;
                    } else if (string.equals("ABL") || string.equals("ABS") || string.equals("VB") || string.equals("image") || string.equals("VB") || string.equals("text")) {
                        this.f497a.m818a(jSONObject);
                    } else {
                        Log.i(C0300h.TAG, "Invalid banner type in 360 json: " + string);
                    }
                }
                this.f497a.f73m = false;
            } catch (Throwable e) {
                Log.w(C0300h.TAG, "error occurred while parsing banner", e);
            } finally {
                this.f497a.f73m = false;
            }
        }
    ...
    public AbstractAdView(Activity activity, C0558c banner360) {
        super(activity);
        this.f62a = false;
        this.f69i = false;
        this.f70j = false;
        ...
        this.f66f = new C05451(this);
        this.f67g = new C02232(this);
        this.f68h = activity;
        this.f76p = banner360;
        this.f70j = C0558c.m1698z();
    ...
    private void m807c() {
        try {
            ...
            if (this.f76p == null) {
                removeAllViews();
                Log.i(C0300h.TAG, "Ad not loaded. Banner data is null.");
                setVisibility(8);
            } else if (this.f76p.m1714c().length() == 0 && this.f76p.m1717f().length() == 0) {
                Log.w(C0300h.TAG, "Tag data is null");
            } else {
                Log.i(C0300h.TAG, "Loading banner ad");
                ...
                Log.i(C0300h.TAG, "Ad loaded successfully");
            }
        } catch (Throwable e) {
            Log.w(C0300h.TAG, "Error occurred while loading banner ad", e);
        }
    }
    ...
    synchronized void getAd() {
        if (f61z != null) {
            ...
            if (this.f73m) {
                Log.i(C0300h.TAG, "Ad request is already in progress.");
            } else if ((System.currentTimeMillis() - this.f63c) / 1000 < ((long) this.f71k)) {
                Log.i(C0300h.TAG, "Ad requested beforing refresh time. Aborting request... ");
            } else {
                synchronized (this) {
                    C0292b c05464 = new C05464(this);
                    if (Util.m977o(getContext())) {
                        c05464.m1004a();
                    } else {
                        post(new C02275(this));
                    }
                }
            }
        } else if (f59b != null) {
            post(new C02243(this));
        }
    }
    ...
    static void m801a(int i, String str) {
        if (str != null && !str.equals("")) {
            BannerAdListener x = C0558c.m1697x();
            switch (i) {
    ...
    void m817a(View view) {
        if (view != null) {
            try {
                ...
                Log.e(C0300h.TAG, "Error in stopping Abstract Ad");
            }
        }
    }
