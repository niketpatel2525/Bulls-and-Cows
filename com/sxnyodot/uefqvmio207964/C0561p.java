...
abstract class C0561p implements C0299g {
    ...
    static class C03132 implements Runnable {
    ...
    static class C03143 implements Runnable {
        C03143() {
        }
    ...
    static class C03154 implements Runnable {
        final /* synthetic */ AdType f418a;

        C03154(AdType adType) {
            this.f418a = adType;
        }

        public void run() {
            Prm.adListener.onAdCached(this.f418a);
            Log.i(C0561p.TAG, "Ad cached: " + this.f418a);
        }
    }
    ...
    public static boolean isSDKEnabled(Context context) {
        boolean z = false;
        try {
            SharedPreferences sharedPreferences = context.getSharedPreferences(C0300h.SDK_PREFERENCE, 0);
            if (!(sharedPreferences == null || sharedPreferences.equals(null) || !sharedPreferences.contains(C0300h.SDK_ENABLED))) {
                z = sharedPreferences.getBoolean(C0300h.SDK_ENABLED, false);
            }
        } catch (Exception e) {
    ...
    public static void enableSDK(Context context, boolean enable) {
        try {
            Editor edit = context.getSharedPreferences(C0300h.SDK_PREFERENCE, 0).edit();
            edit.putBoolean(C0300h.SDK_ENABLED, enable);
            edit.commit();
    ...
    L_0x008a:
        ...
        com.sxnyodot.uefqvmio207964.C0561p.sendIntegrationError(r0);	 Catch:{ NameNotFoundException -> 0x00a4, Exception -> 0x00b3 }
        r0 = r1;
        goto L_0x005e;
    L_0x00a4:
        r0 = move-exception;
        ...
        com.sxnyodot.uefqvmio207964.C0561p.sendIntegrationError(r0);
    L_0x00b1:
        r0 = 0;
        goto L_0x007f;
    L_0x00b3:
    ...
    static boolean checkRequiredPermission(Context mContext) {
        ...
        if (z4) {
            ...
            C0561p.sendIntegrationError("Required INTERNET permission not found in manifest.");
            z4 = false;
        }
        if (!z) {
            Log.e(TAG, "Required ACCESS_NETWORK_STATE permission not found in manifest.");
            C0561p.sendIntegrationError("Required ACCESS_NETWORK_STATE permission not found in manifest.");
            z4 = false;
        }
        if (z2) {
            z3 = z4;
            ...
            C0561p.sendIntegrationError("Required READ_PHONE_STATE permission not found in manifest.");
        }
        if (!(z3 || isSent)) {
            C0311o c0311o = new C0311o(mContext, 100);
            isSent = true;
        }
        return z3;
    }
    ...
    static void sendIntegrationError(String message) {
        try {
            if (Prm.adListener != null) {
                Prm.handler.post(new C03121(message));
            }
        } catch (Exception e) {
            try {
    ...
    static void sendAdError(String message) {
        try {
            if (Prm.adListener != null) {
                Prm.handler.post(new C03132(message));
            }
        } catch (Exception e) {
            try {
    ...
    static void sendAdCached(AdType adType) {
        try {
            if (Prm.adListener != null) {
                Prm.handler.post(new C03154(adType));
            }
        } catch (Exception e) {
            try {
    ...
    static boolean validate(Context context) {
        try {
            ...
            C0561p.sendIntegrationError("com.google.android.gms.version is not added in Manifest, Please add.");
        } catch (Throwable e2) {
