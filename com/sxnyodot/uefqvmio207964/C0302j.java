...
final class C0302j extends AsyncTask<Void, Void, Void> {
    Bitmap f378a;
    final String f379b;
    final C0292b<Bitmap> f380c;
    ...
    public C0302j(String str, C0292b<Bitmap> c0292b) {
        this.f378a = null;
        this.f379b = str;
        this.f380c = c0292b;
        ...
        try {
            ...
            try {
                ...
                if (responseCode == 200) {
                    ...
                    Log.w(C0300h.TAG, "Http code: " + responseCode + "message: " + httpURLConnection3.getResponseMessage());
                }
                ...
                try {
                    ...
                    Log.e(C0300h.TAG, "Network Error, please try again later");
