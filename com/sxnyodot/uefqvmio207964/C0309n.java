...
class C0309n extends Dialog implements OnCancelListener, OnDismissListener {
    ...
    class C03051 extends WebViewClient {
        final /* synthetic */ C0309n f387a;

        C03051(C0309n c0309n) {
            this.f387a = c0309n;
        }
        ...
        public void onPageFinished(WebView view, String url) {
            ...
            try {
                if (this.f387a.f409s) {
                    Log.i(C0300h.TAG, "Error in loading");
                    this.f387a.dismiss();
                    if (C0309n.f396r.equals(C0309n.AD_TYPE_DIALOG_U) || C0309n.f396r.equals(C0309n.AD_TYPE_DIALOG_CC) || C0309n.f396r.equals(C0309n.AD_TYPE_DIALOG_CM)) {
        ...
        public void onReceivedError(WebView view, int errorCode, String description, String failingUrl) {
            ...
            try {
                ...
                Log.e(C0300h.TAG, "Error occurred while loading Overlay Ad: code " + errorCode + ", desc: " + description);
            }
    ...
    class C03062 implements OnTouchListener {
        final /* synthetic */ C0309n f388a;

        C03062(C0309n c0309n) {
            this.f388a = c0309n;
        }
    ...
    class C03073 implements Runnable {
        ...
        final /* synthetic */ C0309n f390b;

        C03073(C0309n c0309n, String str) {
            this.f390b = c0309n;
            this.f389a = str;
        }
        ...
        public void run() {
            try {
                Log.i(C0300h.TAG, "Sending overlay event: ");
                if (C0309n.f394o || !(this.f389a.equals("184") || this.f389a.equals("183"))) {
                    String e = this.f390b.m1037e(this.f389a);
                    Util.m929a("Event: " + this.f389a + ", URL: " + e);
                    if (e == null || e.equals("")) {
                        Log.w(C0300h.TAG, "Event url null");
                    ...
                    Log.i(C0300h.TAG, "Status code: " + statusCode);
                    if (statusCode == 200) {
                        Log.i(C0300h.TAG, "Overlay Data: " + EntityUtils.toString(execute.getEntity()));
                ...
                Log.e(C0300h.TAG, "Exception in overlay: ", e2);
            }
        }
    }
    ...
    private class C0308a {
        ...
        public void close() {
            C0309n.this.dismiss();
            if (C0309n.f396r.equals(C0309n.AD_TYPE_DIALOG_U) || C0309n.f396r.equals(C0309n.AD_TYPE_DIALOG_CC) || C0309n.f396r.equals(C0309n.AD_TYPE_DIALOG_CM)) {
                C0309n.this.m1036a("45");
            } else {
                C0309n.this.m1036a("25");
            }
            C0309n.this.f397a.finish();
        }

        @JavascriptInterface
        public void open(String url) {
            C0309n.this.m1035g(url);
            C0309n.this.f397a.finish();
        }
        ...
        public void call(String number) {
            try {
                ...
                C0309n.this.f397a.startActivity(intent);
                if (C0309n.f396r.equals(C0309n.AD_TYPE_DIALOG_U) || C0309n.f396r.equals(C0309n.AD_TYPE_DIALOG_CC) || C0309n.f396r.equals(C0309n.AD_TYPE_DIALOG_CM)) {
                    C0309n.this.m1036a("44");
                    C0309n.this.f397a.finish();
                }
                C0309n.this.m1036a("24");
                C0309n.this.f397a.finish();
    ...
    public C0309n(Activity activity) {
        super(activity);
        this.f399c = C0300h.TAG;
        this.f400d = "23";
        this.f401e = "24";
        this.f402f = "25";
        this.f403g = "43";
        ...
        try {
            ...
            this.f408q.addJavascriptInterface(new C0308a(), "Overlay");
            this.f408q.setOnTouchListener(this.f398b);
            this.f408q.setWebViewClient(new C03051(this));
            ...
            Log.e(C0300h.TAG, "An error occured while starting Overlay Ad.");
            try {
                dismiss();
                activity.finish();
            } catch (Exception e2) {
    ...
    final void m1036a(String str) {
        synchronized (str) {
            if (Util.m977o(getContext())) {
                new Thread(new C03073(this, str), "overlay_event").start();
                return;
            }
        }
    }
