...
final class IB extends WebView {
    ...
    public IB(Context context, int newWidth, int newHeight, Handler loadingListener, ParseBannerAd ad, C0248a animationListener, boolean isTestMode, AdView adView) {
        super(context);
        this.f207a = IM.TAG;
        try {
            ...
            setWebViewClient(new C02521(this, loadingListener));
    ...
    public boolean dispatchTouchEvent(MotionEvent event) {
        ...
        try {
            ...
            if (g.equalsIgnoreCase("BAU")) {
                Log.i(C0300h.TAG, "Banner url Ads.....");
                m892b(this.f208b.m899c());
                return true;
            }
            if (g.equalsIgnoreCase("BACC")) {
                Log.i(C0300h.TAG, "Banner CC Ads.....");
                C0298f.m1017b(getContext(), this.f208b.m909m());
            } else if (g.equalsIgnoreCase("BACM")) {
                Log.i(C0300h.TAG, "Banner CM Ads.....");
                C0298f.m1016a(getContext(), this.f208b.m908l(), this.f208b.m909m());
            } else {
    ...
    private synchronized void m893c(String str) {
        synchronized (str) {
            if (this.f210d) {
                ...
                new Thread(new C02532(this, str), "banner_event").start();
            }
        }
    }
