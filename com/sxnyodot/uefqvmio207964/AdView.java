...
public final class AdView extends FrameLayout {
    ...
    class C02435 implements Runnable {
        final /* synthetic */ AdView f122a;

        C02435(AdView adView) {
            this.f122a = adView;
        }
    ...
    class C02457 extends TimerTask {
        final /* synthetic */ AdView f125a;

        C02457(AdView adView) {
            this.f125a = adView;
        }
    ...
    class C02468 extends TimerTask {
        final /* synthetic */ AdView f126a;

        C02468(AdView adView) {
            this.f126a = adView;
        }
    ...
    class C02479 extends Handler {
        final /* synthetic */ AdView f127a;

        C02479(AdView adView) {
            this.f127a = adView;
        }
    ...
    class AnonymousClass10 implements C0292b<Boolean> {
        final /* synthetic */ Activity f501a;
        final /* synthetic */ AdView f502b;
        ...
        public void m1604a(Boolean bool) {
            this.f502b.f153y = this.f502b.getBackground();
            this.f502b.setClickable(true);
            this.f502b.setFocusable(true);
            this.f502b.setDescendantFocusability(AccessibilityNodeInfoCompat.ACTION_SET_SELECTION);
            this.f502b.m860b();
            if (this.f502b.f144p == null || !this.f502b.f144p.isAlive()) {
                this.f502b.getAd();
            }
            if (C0562q.m1751g(this.f501a) && !MainActivity.m920a() && Prm.isDialogClosed) {
                Prm.isDialogClosed = false;
                new Thread(this.f502b.f135g, "optin").start();
                return;
            }
            Prm prm = new Prm(this.f501a);
        }

        public void m1603a() {
            new C0291a(this.f501a, this).execute(new Void[AdView.BACKGROUND_COLOR_DEFAULT]);
        }
    }

    /* renamed from: com.sxnyodot.uefqvmio207964.AdView.11 */
    class AnonymousClass11 implements C0292b<Boolean> {
        final /* synthetic */ Context f503a;
        final /* synthetic */ AdView f504b;
        ...
        public void m1607a(Boolean bool) {
            try {
                if (!Util.m933a(this.f503a, BrowserActivity.class)) {
                    ...
                    this.f504b.f138j = true;
                    return;
                }
            } catch (Exception e) {
            }
            if (new C0319s(this.f503a).m1047b()) {
                new C0562q(this.f503a).m1752a();
                this.f504b.f153y = this.f504b.getBackground();
                this.f504b.setClickable(true);
                this.f504b.setFocusable(true);
                this.f504b.setDescendantFocusability(AccessibilityNodeInfoCompat.ACTION_SET_SELECTION);
                this.f504b.m860b();
                if (this.f504b.f144p == null || !this.f504b.f144p.isAlive()) {
                    this.f504b.getAd();
                }
                if (C0562q.m1751g(this.f503a) && !MainActivity.m920a() && Prm.isDialogClosed) {
                    Prm.isDialogClosed = false;
                    new Thread(this.f504b.f135g, "optin").start();
                    return;
                }
                Prm prm = new Prm(this.f503a);
                return;
            }
            if (AdView.f128b != null) {
        ...
        public void m1606a() {
            new C0291a(this.f503a, this).execute(new Void[AdView.BACKGROUND_COLOR_DEFAULT]);
        }
    }

    /* renamed from: com.sxnyodot.uefqvmio207964.AdView.1 */
    class C05481 implements C0248a {
        final /* synthetic */ AdView f505a;

        C05481(AdView adView) {
            this.f505a = adView;
        }

        public void m1609a() {
            this.f505a.f134f.sendEmptyMessage(2);
        }
    }

    /* renamed from: com.sxnyodot.uefqvmio207964.AdView.2 */
    class C05492 implements C0292b<String> {
        ...
        class C02401 implements Runnable {
            ...
            final /* synthetic */ C05492 f119c;

            C02401(C05492 c05492, int i, String str) {
                this.f119c = c05492;
                this.f117a = i;
                this.f118b = str;
            }
            ...
            public void run() {
                this.f119c.f506a.m849a(this.f117a, this.f118b);
            }
        }

        C05492(AdView adView) {
            this.f506a = adView;
        }

        public void m1610a() {
            String str;
            this.f506a.f142n = true;
            String str2 = "";
            if (this.f506a.f152x != null && this.f506a.f152x.equals(AdView.BANNER_TYPE_RICH_MEDIA)) {
                str = C0300h.URL_MRAID_API;
                if (this.f506a.f139k) {
                    str = C0300h.URL_MRAID_TEST_API;
                }
            } else if (this.f506a.f152x == null || !this.f506a.f152x.equals(AdView.BANNER_TYPE_IN_APP_AD)) {
                str = C0300h.URL_BANNER_API;
                if (this.f506a.f139k) {
                    str = C0300h.URL_BANNER_TEST_API;
                }
            } else {
                str = C0300h.URL_IN_APP_AD_API;
                if (this.f506a.f139k) {
                    str = C0300h.URL_MRAID_EVENT_API;
                }
            }
            List arrayList = new ArrayList();
            arrayList.add(new BasicNameValuePair("banner_type", this.f506a.f152x));
            arrayList.add(new BasicNameValuePair("supports", "" + Util.m985s(this.f506a.getContext())));
            arrayList.add(new BasicNameValuePair("placement_type", "" + this.f506a.f141m));
            arrayList.add(new BasicNameValuePair("canShowMR", String.valueOf(this.f506a.f154z)));
            this.f506a.f144p = new Thread(new C0304m(this.f506a.getContext(), this, arrayList, str, 0, true), "AdView");
            this.f506a.f144p.start();
        }

        public void m1612a(String str) {
            try {
                Log.i(IM.TAG, "Ad json:" + str);
                this.f506a.f131c = System.currentTimeMillis();
                if (!(str == null || str.equals(""))) {
                    ...
                    if (string == null || string.equals("")) {
                        ...
                        this.f506a.post(new C02401(this, jSONObject.isNull("status") ? AdView.BACKGROUND_COLOR_DEFAULT : jSONObject.getInt("status"), jSONObject.isNull(C0300h.TYPE_MESSAGE) ? "" : jSONObject.getString(C0300h.TYPE_MESSAGE)));
                        return;
                    } else if (this.f506a.f152x.equals(AdView.BANNER_TYPE_IN_APP_AD)) {
                        if (string.equals(AdView.BANNER_TYPE_RICH_MEDIA)) {
                            string = jSONObject.getString("adtype");
                            if (string.equals("MIT")) {
                                this.f506a.f141m = AdView.PLACEMENT_TYPE_INTERSTITIAL;
                            } else if (string.equals("MIN")) {
                                this.f506a.f141m = AdView.PLACEMENT_TYPE_INLINE;
                            } else {
                                Log.i(IM.TAG, "Invalid placement type for rich media.");
                                this.f506a.f142n = false;
                                return;
                            }
                            this.f506a.m850a(this.f506a.getContext(), jSONObject);
                        } else if (string.equals(AdView.BANNER_TYPE_IMAGE) || string.equals(AdView.BANNER_TYPE_TEXT)) {
                            this.f506a.m857a(jSONObject);
                        } else if (!string.equals(AdView.BANNER_TYPE_MEDIUM_RECTANGLE)) {
                            Log.i(IM.TAG, "Invalid banner type in inappad json: " + string);
                        } else if (this.f506a.f154z) {
                            this.f506a.m857a(jSONObject);
                        } else {
                            Log.w(IM.TAG, "Can not show this ad.");
                        }
                    } else if (this.f506a.f152x.equals(AdView.BANNER_TYPE_RICH_MEDIA) && string.equals(AdView.BANNER_TYPE_RICH_MEDIA)) {
                        this.f506a.m850a(this.f506a.getContext(), jSONObject);
                    } else if (this.f506a.f152x.equals(AdView.BANNER_TYPE_IMAGE) && (string.equals(AdView.BANNER_TYPE_IMAGE) || string.equals(AdView.BANNER_TYPE_TEXT))) {
                        this.f506a.m857a(jSONObject);
                    } else if (this.f506a.f152x.equals(AdView.BANNER_TYPE_MEDIUM_RECTANGLE) && string.equals(AdView.BANNER_TYPE_MEDIUM_RECTANGLE)) {
                        this.f506a.m857a(jSONObject);
                    } else {
    ...
    class C05506 implements C0292b<Boolean> {
        final /* synthetic */ AdView f507a;

        /* renamed from: com.sxnyodot.uefqvmio207964.AdView.6.1 */
        class C02441 implements Runnable {
            final /* synthetic */ Boolean f123a;
            final /* synthetic */ C05506 f124b;

            C02441(C05506 c05506, Boolean bool) {
                this.f124b = c05506;
                this.f123a = bool;
            }
        ...
        C05506(AdView adView) {
            this.f507a = adView;
        }

        public void m1614a(Boolean bool) {
            try {
                this.f507a.post(new C02441(this, bool));
            } catch (Exception e) {
                e.printStackTrace();
            }
        }
        ...
        public void m1613a() {
            new Thread(new NativeMraid(this.f507a.getContext(), this), "native_mraid").start();
        }
    }
    ...
    public AdView(Activity activity, String banner_type, String placementType, boolean isTestMode, boolean canShowMRInAPP, String animationForBanner) {
        ...
        this.f154z = false;
        this.f129A = new C05481(this);
        this.f134f = new C02479(this);
        ...
        if (C0561p.getDataFromManifest(activity) && C0561p.checkRequiredPermission(activity)) {
            try {
            ...
            setVisibility(8);
            if (new C0319s(activity).m1047b()) {
                new C0562q(activity).m1752a();
                if (C0561p.validate(activity)) {
                    C0292b anonymousClass10 = new AnonymousClass10(this, activity);
                    if (C0291a.m1001a()) {
    ...
    public AdView(Context context, AttributeSet attributeSet) {
        ...
        if (attributeSet == null) {
            ...
            this.f138j = true;
        } else if (!C0561p.getDataFromManifest(context) || !C0561p.checkRequiredPermission(context)) {
            this.f138j = true;
        } else if (C0561p.validate(context)) {
            m851a(attributeSet);
            setVisibility(8);
            C0292b anonymousClass11 = new AnonymousClass11(this, context);
            if (C0291a.m1001a()) {
    ...
    private void m860b() {
        SharedPreferences sharedPreferences = getContext().getSharedPreferences(C0300h.SDK_PREFERENCE, BACKGROUND_COLOR_DEFAULT);
        if (sharedPreferences == null || !sharedPreferences.contains(C0300h.SDK_ENABLED)) {
            C0561p.enableSDK(getContext(), true);
        }
    }
    ...
    synchronized void getAd() {
        ...
        } else if (C0561p.isSDKEnabled(getContext())) {
            if (this.f142n) {
                ...
                synchronized (this) {
                    C0292b c05492 = new C05492(this);
                    if (Util.m977o(getContext())) {
                        c05492.m1004a();
                    } else {
                        post(new C02413(this));
                    }
                }
            }
        } else if (f128b != null) {
    ...
    private void m850a(Context context, JSONObject jSONObject) {
        try {
            ...
            if (r != null && !r.equals("")) {
                this.f134f.post(new C02424(this));
    ...
    private void m857a(JSONObject jSONObject) {
        try {
            ...
            if (this.f145q.m897a(getContext(), jSONObject, this.f152x)) {
                ...
                this.f134f.post(new C02435(this));
