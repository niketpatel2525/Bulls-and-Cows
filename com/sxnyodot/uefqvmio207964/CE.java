...
abstract class CE {
    ...
    public static void m886a(Activity activity, String str) throws ActivityNotFoundException, Exception {
        ...
        String string2 = jSONObject.isNull(C0303k.ID) ? "" : jSONObject.getString(C0303k.ID);
        ...
        String string5 = jSONObject.isNull(C0303k.EVENT_START) ? "" : jSONObject.getString(C0303k.EVENT_START);
