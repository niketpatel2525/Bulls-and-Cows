...
import com.google.android.gms.internal.C0158o.C0468a;
...
public final class GoogleAuthUtil {
    ...
    private static String m16a(Context context, String str, String str2, Bundle bundle) throws IOException, UserRecoverableNotifiedException, GoogleAuthException {
        ...
        try {
            ...
            Notification notification = new Notification(17301642, resources.getString(C0048R.string.auth_client_play_services_err_notification_msg), System.currentTimeMillis());
            notification.flags |= 16;
            CharSequence charSequence = context.getApplicationInfo().name;
            if (TextUtils.isEmpty(charSequence)) {
                charSequence = context.getPackageName();
            }
            CharSequence string = resources.getString(C0048R.string.auth_client_requested_by_msg, new Object[]{charSequence});
            switch (e.getConnectionStatusCode()) {
                case DetectedActivity.ON_BICYCLE /*1*/:
                    i = C0048R.string.auth_client_needs_installation_title;
                    break;
                case DetectedActivity.ON_FOOT /*2*/:
                    i = C0048R.string.auth_client_needs_update_title;
                    break;
                case DetectedActivity.STILL /*3*/:
                    i = C0048R.string.auth_client_needs_enabling_title;
                    break;
                default:
                    i = C0048R.string.auth_client_using_bad_version_title;
                    break;
            }
    ...
    public static String getToken(Context context, String accountName, String scope, Bundle extras) throws IOException, UserRecoverableAuthException, GoogleAuthException {
        ...
        ServiceConnection c0052a = new C0052a();
        if (applicationContext.bindService(iJ, c0052a, 1)) {
            try {
                Bundle a = C0468a.m1517a(c0052a.aG()).m688a(accountName, scope, extras);
                Object string = a.getString("authtoken");
                if (TextUtils.isEmpty(string)) {
                    String string2 = a.getString(C0303k.ERROR);
                ...
                applicationContext.unbindService(c0052a);
                return string;
            } catch (Throwable e) {
