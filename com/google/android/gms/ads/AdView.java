...
public final class AdView extends ViewGroup {
    ...
    public AdView(Context context, AttributeSet attrs, int defStyle) {
        ...
        try {
            ...
            if (isInEditMode()) {
                cm.m289b(this, new C0473x(context, this.f11c), "Ads by Google");
            }
        } catch (IllegalArgumentException e) {
            cm.m287a(this, new C0473x(context, AdSize.BANNER), e.getMessage());
        }
    }
    ...
    private void m9c(String str) throws RemoteException {
        ...
        this.dU = C0471u.m1522a(context, new C0473x(context, this.f11c), this.dV, this.dS);
        if (this.dT != null) {
    ...
    private void m11x() {
        try {
            C0070b z = this.dU.m172z();
            if (z != null) {
                addView((View) C0569c.m1772b(z));
            }
        } catch (Throwable e) {
    ...
    public void loadAd(AdRequest adRequest) {
        try {
            ...
            if (this.dU.m171a(new C0472v(getContext(), adRequest))) {
