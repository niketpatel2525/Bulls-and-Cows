...
public final class AdSize {
    ...
    public int getHeightInPixels(Context context) {
        return this.dQ == AUTO_HEIGHT ? C0473x.m1527b(context.getResources().getDisplayMetrics()) : cm.m285a(context, this.dQ);
    }
    ...
    public int getWidthInPixels(Context context) {
        return this.dP == FULL_WIDTH ? C0473x.m1526a(context.getResources().getDisplayMetrics()) : cm.m285a(context, this.dP);
    }
