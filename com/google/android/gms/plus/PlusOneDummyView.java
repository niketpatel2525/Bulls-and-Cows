...
public class PlusOneDummyView extends FrameLayout {
    ...
    private static class C0542a implements C0206d {
        private Context mContext;

        private C0542a(Context context) {
    ...
    private static class C0543b implements C0206d {
        private Context mContext;

        private C0543b(Context context) {
            this.mContext = context;
        }
    ...
    private static class C0544c implements C0206d {
        private Context mContext;

        private C0544c(Context context) {
            this.mContext = context;
        }
    ...
    private C0206d cU() {
        C0206d c0543b = new C0543b(null);
        if (!c0543b.isValid()) {
            c0543b = new C0544c(null);
        }
        return !c0543b.isValid() ? new C0542a(null) : c0543b;
    }
}
