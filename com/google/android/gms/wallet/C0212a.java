...
public class C0212a implements Creator<Address> {
    static void m776a(Address address, Parcel parcel, int i) {
        int k = C0066b.m133k(parcel);
        C0066b.m131c(parcel, 1, address.getVersionCode());
        C0066b.m121a(parcel, 2, address.name, false);
        C0066b.m121a(parcel, 3, address.tu, false);
        C0066b.m121a(parcel, 4, address.tv, false);
        C0066b.m121a(parcel, 5, address.tw, false);
        C0066b.m121a(parcel, 6, address.hl, false);
        C0066b.m121a(parcel, 7, address.tx, false);
        C0066b.m121a(parcel, 8, address.ty, false);
        C0066b.m121a(parcel, 9, address.tz, false);
        C0066b.m121a(parcel, 10, address.tA, false);
        C0066b.m124a(parcel, 11, address.tB);
        C0066b.m121a(parcel, 12, address.tC, false);
        ...
        while (parcel.dataPosition() < j) {
            ...
            switch (C0065a.m107y(i2)) {
                ...
                case ConnectionResult.SERVICE_INVALID /*9*/:
                    str8 = C0065a.m94l(parcel, i2);
                    break;
                case ConnectionResult.DEVELOPER_ERROR /*10*/:
                    str9 = C0065a.m94l(parcel, i2);
                    break;
                case ConnectionResult.LICENSE_CHECK_FAILED /*11*/:
                    z = C0065a.m83c(parcel, i2);
                    break;
                case ConnectionResult.DATE_INVALID /*12*/:
                    str10 = C0065a.m94l(parcel, i2);
                    break;
                default:
