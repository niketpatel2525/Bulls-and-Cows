...
public final class RoomEntity extends en implements Room {
    ...
    static final class C0365a extends C0082b {
        C0365a() {
        }
    ...
    static String m2084b(Room room) {
        return dl.m387d(room).m386a("RoomId", room.getRoomId()).m386a("CreatorId", room.getCreatorId()).m386a("CreationTimestamp", Long.valueOf(room.getCreationTimestamp())).m386a("RoomStatus", Integer.valueOf(room.getStatus())).m386a(C0303k.DESCRIPTION, room.getDescription()).m386a("Variant", Integer.valueOf(room.getVariant())).m386a("AutoMatchCriteria", room.getAutoMatchCriteria()).m386a("Participants", room.getParticipants()).m386a("AutoMatchWaitEstimateSeconds", Integer.valueOf(room.getAutoMatchWaitEstimateSeconds())).toString();
    }
