...
import com.google.android.gms.games.multiplayer.C0575d;
import com.google.android.gms.games.multiplayer.Participant;
import com.google.android.gms.plus.PlusShare;
import java.util.ArrayList;

/* renamed from: com.google.android.gms.games.multiplayer.realtime.c */
public final class C0577c extends C0054b implements Room {
    private final int nu;

    C0577c(C0348d c0348d, int i, int i2) {
        super(c0348d, i);
        this.nu = i2;
    }
    ...
    public ArrayList<Participant> getParticipants() {
        ...
        for (int i = 0; i < this.nu; i++) {
            arrayList.add(new C0575d(this.jf, this.ji + i));
        }
        return arrayList;
    }
