...
public final class GooglePlayServicesUtil {
    ...
    public static Dialog m24a(int i, Activity activity, int i2, OnCancelListener onCancelListener, int i3) {
        ...
        switch (i) {
            ...
            case DetectedActivity.ON_BICYCLE /*1*/:
                return message.setTitle(C0048R.string.common_google_play_services_install_title).create();
            case DetectedActivity.ON_FOOT /*2*/:
                return message.setTitle(C0048R.string.common_google_play_services_update_title).create();
            case DetectedActivity.STILL /*3*/:
                return message.setTitle(C0048R.string.common_google_play_services_enable_title).create();
            case DetectedActivity.UNKNOWN /*4*/:
            case GamesClient.STATUS_NETWORK_ERROR_OPERATION_FAILED /*6*/:
                return message.setTitle(C0048R.string.common_google_play_services_unknown_issue).create();
            case DetectedActivity.TILTING /*5*/:
                Log.e("GooglePlayServicesUtil", "An invalid account was specified when connecting. Please provide a valid account.");
                return message.setTitle(C0048R.string.common_google_play_services_invalid_account_title).create();
            case GamesClient.STATUS_LICENSE_CHECK_FAILED /*7*/:
                Log.e("GooglePlayServicesUtil", "Network error occurred. Please retry request later.");
                return message.setTitle(C0048R.string.common_google_play_services_network_error_title).create();
            case GamesClient.STATUS_APP_MISCONFIGURED /*8*/:
                Log.e("GooglePlayServicesUtil", "Internal error occurred. Please see logs for detailed information");
                return message.setTitle(C0048R.string.common_google_play_services_unknown_issue).create();
            case ConnectionResult.SERVICE_INVALID /*9*/:
                Log.e("GooglePlayServicesUtil", "Google Play services is invalid. Cannot recover.");
                return message.setTitle(C0048R.string.common_google_play_services_unsupported_title).create();
    ...
    public static boolean aI() {
        return iX ? iY : C0300h.MODEL_USER.equals(Build.TYPE);
    }
    ...
    public static String m29b(Context context, int i) {
        ...
        switch (i) {
            case DetectedActivity.ON_BICYCLE /*1*/:
                return resources.getString(C0048R.string.common_google_play_services_install_button);
            case DetectedActivity.ON_FOOT /*2*/:
                return resources.getString(C0048R.string.common_google_play_services_update_button);
            case DetectedActivity.STILL /*3*/:
                return resources.getString(C0048R.string.common_google_play_services_enable_button);
            default:
    ...
    public static String m30b(Context context, int i, int i2) {
        ...
        switch (i) {
            case DetectedActivity.ON_BICYCLE /*1*/:
                string = m26a(context.getResources()) ? resources.getString(C0048R.string.common_google_play_services_install_text_tablet) : resources.getString(C0048R.string.common_google_play_services_install_text_phone);
                return m34n(i2) ? string + " (via Bazaar)" : string;
            case DetectedActivity.ON_FOOT /*2*/:
                string = resources.getString(C0048R.string.common_google_play_services_update_text);
                return m34n(i2) ? string + " (via Bazaar)" : string;
            case DetectedActivity.STILL /*3*/:
                return resources.getString(C0048R.string.common_google_play_services_enable_text);
            case DetectedActivity.TILTING /*5*/:
                return resources.getString(C0048R.string.common_google_play_services_invalid_account_text);
            case GamesClient.STATUS_LICENSE_CHECK_FAILED /*7*/:
                return resources.getString(C0048R.string.common_google_play_services_network_error_text);
            case ConnectionResult.SERVICE_INVALID /*9*/:
                return resources.getString(C0048R.string.common_google_play_services_unsupported_text);
            case ConnectionResult.DATE_INVALID /*12*/:
                return resources.getString(C0048R.string.common_google_play_services_unsupported_date_text);
            default:
                return resources.getString(C0048R.string.common_google_play_services_unknown_issue);
        }
    }
    ...
    public static int isGooglePlayServicesAvailable(Context context) {
        ...
        try {
            context.getResources().getString(C0048R.string.common_google_play_services_unknown_issue);
        } catch (Throwable th) {
