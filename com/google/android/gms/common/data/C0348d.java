...
public final class C0348d implements SafeParcelable {
    public static final C0056e CREATOR;
    private static final C0055a ju;
    ...
    public static class C0055a {
        ...
        private C0055a(String[] strArr, String str) {
    ...
    static class C03471 extends C0055a {
        C03471(String[] strArr, String str) {
            super(str, null);
        }
    }
    ...
    static {
        CREATOR = new C0056e();
        ju = new C03471(new String[0], null);
    }

    C0348d(int i, String[] strArr, CursorWindow[] cursorWindowArr, int i2, Bundle bundle) {
        this.mClosed = false;
        this.jt = true;
        this.iM = i;
        this.jm = strArr;
    ...
    private C0348d(C0055a c0055a, int i, Bundle bundle) {
        this(c0055a.jm, C0348d.m1090a(c0055a), i, bundle);
    }

    public C0348d(String[] strArr, CursorWindow[] cursorWindowArr, int i, Bundle bundle) {
        this.mClosed = false;
        this.jt = true;
        this.iM = 1;
        this.jm = (String[]) dm.m392e(strArr);
    ...
    public static C0348d m1089a(int i, Bundle bundle) {
        return new C0348d(ju, i, bundle);
    }

    private static CursorWindow[] m1090a(C0055a c0055a) {
        int i = 0;
        if (c0055a.jm.length == 0) {
            return new CursorWindow[0];
        }
        ArrayList c = c0055a.jv;
        int size = c.size();
        CursorWindow cursorWindow = new CursorWindow(false);
        ArrayList arrayList = new ArrayList();
        arrayList.add(cursorWindow);
        cursorWindow.setNumColumns(c0055a.jm.length);
        int i2 = 0;
        int i3 = 0;
        while (i2 < size) {
            int i4;
            ...
            boolean z = true;
            for (int i6 = 0; i6 < c0055a.jm.length && z; i6++) {
                String str = c0055a.jm[i6];
            ...
            if (z) {
                ...
                try {
                    ...
                    cursorWindow3.setNumColumns(c0055a.jm.length);
    ...
    public static C0348d m1092r(int i) {
        return C0348d.m1089a(i, null);
    }
