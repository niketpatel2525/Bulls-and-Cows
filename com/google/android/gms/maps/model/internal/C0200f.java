...
public interface C0200f extends IInterface {

    /* renamed from: com.google.android.gms.maps.model.internal.f.a */
    public static abstract class C0539a extends Binder implements C0200f {

        /* renamed from: com.google.android.gms.maps.model.internal.f.a.a */
        private static class C0538a implements C0200f {
            private IBinder dG;
            ...
            public boolean m1595a(C0200f c0200f) throws RemoteException {
                boolean z = false;
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.model.internal.ITileOverlayDelegate");
                    obtain.writeStrongBinder(c0200f != null ? c0200f.asBinder() : null);
        ...
        public static C0200f ai(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.maps.model.internal.ITileOverlayDelegate");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof C0200f)) ? new C0538a(iBinder) : (C0200f) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case GamesClient.STATUS_APP_MISCONFIGURED /*8*/:
                    data.enforceInterface("com.google.android.gms.maps.model.internal.ITileOverlayDelegate");
                    isVisible = m766a(C0539a.ai(data.readStrongBinder()));
                    reply.writeNoException();
                    if (isVisible) {
                        i = 1;
                    }
    ...
    boolean m766a(C0200f c0200f) throws RemoteException;
