...
public class MapFragment extends Fragment {
    private final C0478b pH;
    private GoogleMap pI;

    /* renamed from: com.google.android.gms.maps.MapFragment.a */
    static class C0477a implements LifecycleDelegate {
        private final Fragment pJ;
        private final IMapFragmentDelegate pK;

        public C0477a(Fragment fragment, IMapFragmentDelegate iMapFragmentDelegate) {
    ...
    static class C0478b extends C0069a<C0477a> {
        private Activity fD;
        private final Fragment pJ;
        protected C0071d<C0477a> pL;

        C0478b(Fragment fragment) {
            this.pJ = fragment;
        }
        ...
        protected void m1536a(C0071d<C0477a> c0071d) {
            this.pL = c0071d;
            cE();
        }
        ...
        public void cE() {
            if (this.fD != null && this.pL != null && bP() == null) {
                try {
                    ...
                    this.pL.m143a(new C0477a(this.pJ, C0184q.m729u(this.fD).m715f(C0569c.m1773g(this.fD))));
                } catch (RemoteException e) {
                    throw new RuntimeRemoteException(e);
    ...
    protected IMapFragmentDelegate cD() {
        this.pH.cE();
        return this.pH.bP() == null ? null : ((C0477a) this.pH.bP()).cD();
    }
