...
import com.google.android.gms.maps.internal.C0183p;
...
public class SupportMapFragment extends Fragment {
    ...
    private final C0482b pT;

    /* renamed from: com.google.android.gms.maps.SupportMapFragment.a */
    static class C0481a implements LifecycleDelegate {
        private final IMapFragmentDelegate pK;
        private final Fragment pU;

        public C0481a(Fragment fragment, IMapFragmentDelegate iMapFragmentDelegate) {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            if (arguments != null && arguments.containsKey("MapOptions")) {
                C0183p.m726a(savedInstanceState, "MapOptions", arguments.getParcelable("MapOptions"));
            }
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
            try {
                return (View) C0569c.m1772b(this.pK.onCreateView(C0569c.m1773g(inflater), C0569c.m1773g(container), savedInstanceState));
            } catch (RemoteException e) {
                throw new RuntimeRemoteException(e);
            }
        }
        ...
        public void onInflate(Activity activity, Bundle attrs, Bundle savedInstanceState) {
            try {
                this.pK.onInflate(C0569c.m1773g(activity), (GoogleMapOptions) attrs.getParcelable("MapOptions"), savedInstanceState);
            } catch (RemoteException e) {
                throw new RuntimeRemoteException(e);
            }
        }
    ...
    static class C0482b extends C0069a<C0481a> {
        private Activity fD;
        protected C0071d<C0481a> pL;
        private final Fragment pU;

        C0482b(Fragment fragment) {
            this.pU = fragment;
        }
        ...
        protected void m1539a(C0071d<C0481a> c0071d) {
            this.pL = c0071d;
            cE();
        }
        ...
        public void cE() {
            if (this.fD != null && this.pL != null && bP() == null) {
                try {
                    ...
                    this.pL.m143a(new C0481a(this.pU, C0184q.m729u(this.fD).m715f(C0569c.m1773g(this.fD))));
                } catch (RemoteException e) {
                    throw new RuntimeRemoteException(e);
    ...
    protected IMapFragmentDelegate cD() {
        this.pT.cE();
        return this.pT.bP() == null ? null : ((C0481a) this.pT.bP()).cD();
    }
