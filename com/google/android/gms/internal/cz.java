...
public final class cz extends Drawable implements Callback {
    ...
    private static final class C0130a extends Drawable {
        private static final C0130a ks;
        private static final C0129a kt;

        /* renamed from: com.google.android.gms.internal.cz.a.a */
        private static final class C0129a extends ConstantState {
            private C0129a() {
            }
    ...
    static final class C0131b extends ConstantState {
        int ku;
        int kv;

        C0131b(C0131b c0131b) {
            if (c0131b != null) {
                this.ku = c0131b.ku;
                this.kv = c0131b.kv;
            }
    ...
    public cz(Drawable drawable, Drawable drawable2) {
        ...
        C0131b c0131b = this.kl;
        c0131b.kv |= drawable.getChangingConfigurations();
        if (drawable2 == null) {
            drawable2 = C0130a.ks;
        }
        this.kn = drawable2;
        ...
        c0131b = this.kl;
        c0131b.kv |= drawable2.getChangingConfigurations();
    }
