...
import com.google.android.gms.internal.gh.C0463a;
...
public class gj extends de<gh> {
    ...
    final class C0604a extends C0465a {
        private final int ky;
        final /* synthetic */ gj ut;

        public C0604a(gj gjVar, int i) {
            this.ut = gjVar;
            this.ky = i;
        }
    ...
    protected void m1989a(dj djVar, C0582d c0582d) throws RemoteException {
        djVar.m370a(c0582d, GooglePlayServicesUtil.GOOGLE_PLAY_SERVICES_VERSION_CODE);
    }
    ...
    protected gh au(IBinder iBinder) {
        return C0463a.as(iBinder);
    }

    public void changeMaskedWallet(String googleTransactionId, String merchantTransactionId, int requestCode) {
        Bundle eb = eb();
        Object c0604a = new C0604a(this, requestCode);
        try {
            ((gh) bd()).m645a(googleTransactionId, merchantTransactionId, eb, c0604a);
        } catch (Throwable e) {
            Log.e("WalletClientImpl", "RemoteException changing masked wallet", e);
            c0604a.m1986a(8, null, null);
        }
    }

    public void checkForPreAuthorization(int requestCode) {
        Bundle eb = eb();
        gi c0604a = new C0604a(this, requestCode);
        try {
            ((gh) bd()).m641a(eb, c0604a);
        } catch (Throwable e) {
            Log.e("WalletClientImpl", "RemoteException during checkForPreAuthorization", e);
            c0604a.m1987a(8, false, null);
        }
    }
    ...
    public void loadFullWallet(FullWalletRequest request, int requestCode) {
        gi c0604a = new C0604a(this, requestCode);
        try {
            ((gh) bd()).m642a(request, eb(), c0604a);
        } catch (Throwable e) {
            Log.e("WalletClientImpl", "RemoteException getting full wallet", e);
            c0604a.m1985a(8, null, null);
        }
    }
