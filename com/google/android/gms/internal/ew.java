...
public interface ew extends IInterface {
    ...
    public static abstract class C0441a extends Binder implements ew {

        /* renamed from: com.google.android.gms.internal.ew.a.a */
        private static class C0440a implements ew {
            private IBinder dG;
        ...
        public static ew m1455E(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof ew)) ? new C0440a(iBinder) : (ew) queryLocalInterface;
        }
