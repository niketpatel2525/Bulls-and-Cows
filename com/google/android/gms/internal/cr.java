...
public class cr extends WebViewClient {
    ...
    public final void m313a(be beVar) {
        ...
        C0160q c0160q = (!az || this.fG.av().ex) ? this.ia : null;
        if (!az) {
            biVar = this.ib;
        }
        m309a(new bh(beVar, c0160q, biVar, this.f48if, this.fG.ay()));
    }

    public final void m314a(C0120a c0120a) {
        this.ic = c0120a;
    }

    public void m315a(C0160q c0160q, bi biVar, ag agVar, bl blVar, boolean z) {
    ...
    public final void m317a(boolean z, int i) {
        C0160q c0160q = (!this.fG.az() || this.fG.av().ex) ? this.ia : null;
        m309a(new bh(c0160q, this.ib, this.f48if, this.fG, z, i, this.fG.ay()));
    }
    ...
    public final void m318a(boolean z, int i, String str) {
        ...
        m309a(new bh(c0160q, biVar, this.ey, this.f48if, this.fG, z, i, str, this.fG.ay()));
    }
    ...
    public final void m319a(boolean z, int i, String str, String str2) {
        ...
        m309a(new bh(c0160q, biVar, this.ey, this.f48if, this.fG, z, i, str, str2, this.fG.ay()));
    }
