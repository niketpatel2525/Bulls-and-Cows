...
public abstract class bs extends cg {
    private final bu eI;
    private final C0110a gx;

    /* renamed from: com.google.android.gms.internal.bs.a */
    public static final class C0578a extends bs {
        private final Context mContext;

        public C0578a(Context context, bu buVar, C0110a c0110a) {
            super(buVar, c0110a);
    ...
    public static final class C0579b extends bs implements ConnectionCallbacks, OnConnectionFailedListener {
        private final Object eJ;
        private final C0110a gx;
        private final bt gy;

        public C0579b(Context context, bu buVar, C0110a c0110a) {
            super(buVar, c0110a);
            this.eJ = new Object();
            this.gx = c0110a;
    ...
    public bs(bu buVar, C0110a c0110a) {
        this.eI = buVar;
        this.gx = c0110a;
    }
