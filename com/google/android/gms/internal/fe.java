...
public interface fe extends IInterface {
    ...
    public static abstract class C0450a extends Binder implements fe {

        /* renamed from: com.google.android.gms.internal.fe.a.a */
        private static class C0449a implements fe {
            private IBinder dG;
        ...
        public static fe al(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof fe)) ? new C0449a(iBinder) : (fe) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case DetectedActivity.ON_BICYCLE /*1*/:
                    ...
                    m586a(C0448a.ak(data.readStrongBinder()), data.readInt() != 0 ? (Uri) Uri.CREATOR.createFromParcel(data) : null, data.readInt() != 0 ? (Bundle) Bundle.CREATOR.createFromParcel(data) : null, data.readInt() != 0);
                    return true;
                case 1598968902:
