...
public final class cq extends WebView implements DownloadListener {
    ...
    private cq(MutableContextWrapper mutableContextWrapper, C0473x c0473x, boolean z, boolean z2, C0151h c0151h, co coVar) {
    ...
    public static cq m303a(Context context, C0473x c0473x, boolean z, boolean z2, C0151h c0151h, co coVar) {
        return new cq(new MutableContextWrapper(context), c0473x, z, z2, c0151h, coVar);
    }
    ...
    public void m304a(Context context, C0473x c0473x) {
        synchronized (this.eJ) {
    ...
    public void as() {
        ...
        hashMap.put(C0303k.VERSION, this.hV.hP);
