...
public interface bn extends IInterface {
    ...
    public static abstract class C0402a extends Binder implements bn {

        /* renamed from: com.google.android.gms.internal.bn.a.a */
        private static class C0401a implements bn {
            private IBinder dG;
        ...
        public static bn m1191m(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof bn)) ? new C0401a(iBinder) : (bn) queryLocalInterface;
        }
