...
public final class fq extends dw implements SafeParcelable, ItemScope {
    ...
    static {
        CREATOR = new fr();
        rH = new HashMap();
        rH.put("about", C0424a.m1278a("about", 2, fq.class));
        rH.put("additionalName", C0424a.m1285h("additionalName", 3));
        rH.put("address", C0424a.m1278a("address", 4, fq.class));
        rH.put("addressCountry", C0424a.m1284g("addressCountry", 5));
        rH.put("addressLocality", C0424a.m1284g("addressLocality", 6));
        rH.put("addressRegion", C0424a.m1284g("addressRegion", 7));
        rH.put("associated_media", C0424a.m1279b("associated_media", 8, fq.class));
        rH.put("attendeeCount", C0424a.m1281d("attendeeCount", 9));
        rH.put("attendees", C0424a.m1279b("attendees", 10, fq.class));
        rH.put("audio", C0424a.m1278a("audio", 11, fq.class));
        rH.put("author", C0424a.m1279b("author", 12, fq.class));
        rH.put("bestRating", C0424a.m1284g("bestRating", 13));
        rH.put("birthDate", C0424a.m1284g("birthDate", 14));
        rH.put("byArtist", C0424a.m1278a("byArtist", 15, fq.class));
        rH.put("caption", C0424a.m1284g("caption", 16));
        rH.put("contentSize", C0424a.m1284g("contentSize", 17));
        rH.put("contentUrl", C0424a.m1284g("contentUrl", 18));
        rH.put("contributor", C0424a.m1279b("contributor", 19, fq.class));
        rH.put("dateCreated", C0424a.m1284g("dateCreated", 20));
        rH.put("dateModified", C0424a.m1284g("dateModified", 21));
        rH.put("datePublished", C0424a.m1284g("datePublished", 22));
        rH.put(PlusShare.KEY_CONTENT_DEEP_LINK_METADATA_DESCRIPTION, C0424a.m1284g(PlusShare.KEY_CONTENT_DEEP_LINK_METADATA_DESCRIPTION, 23));
        rH.put("duration", C0424a.m1284g("duration", 24));
        rH.put("embedUrl", C0424a.m1284g("embedUrl", 25));
        rH.put("endDate", C0424a.m1284g("endDate", 26));
        rH.put("familyName", C0424a.m1284g("familyName", 27));
        rH.put("gender", C0424a.m1284g("gender", 28));
        rH.put("geo", C0424a.m1278a("geo", 29, fq.class));
        rH.put("givenName", C0424a.m1284g("givenName", 30));
        rH.put(IM.HEIGHT, C0424a.m1284g(IM.HEIGHT, 31));
        rH.put(C0303k.ID, C0424a.m1284g(C0303k.ID, 32));
        rH.put("image", C0424a.m1284g("image", 33));
        rH.put("inAlbum", C0424a.m1278a("inAlbum", 34, fq.class));
        rH.put(C0300h.LATITUDE, C0424a.m1282e(C0300h.LATITUDE, 36));
        rH.put("location", C0424a.m1278a("location", 37, fq.class));
        rH.put(C0300h.LONGITUDE, C0424a.m1282e(C0300h.LONGITUDE, 38));
        rH.put("name", C0424a.m1284g("name", 39));
        rH.put("partOfTVSeries", C0424a.m1278a("partOfTVSeries", 40, fq.class));
        rH.put("performers", C0424a.m1279b("performers", 41, fq.class));
        rH.put("playerType", C0424a.m1284g("playerType", 42));
        rH.put("postOfficeBoxNumber", C0424a.m1284g("postOfficeBoxNumber", 43));
        rH.put("postalCode", C0424a.m1284g("postalCode", 44));
        rH.put("ratingValue", C0424a.m1284g("ratingValue", 45));
        rH.put("reviewRating", C0424a.m1278a("reviewRating", 46, fq.class));
        rH.put("startDate", C0424a.m1284g("startDate", 47));
        rH.put("streetAddress", C0424a.m1284g("streetAddress", 48));
        rH.put("text", C0424a.m1284g("text", 49));
        rH.put("thumbnail", C0424a.m1278a("thumbnail", 50, fq.class));
        rH.put(PlusShare.KEY_CONTENT_DEEP_LINK_METADATA_THUMBNAIL_URL, C0424a.m1284g(PlusShare.KEY_CONTENT_DEEP_LINK_METADATA_THUMBNAIL_URL, 51));
        rH.put("tickerSymbol", C0424a.m1284g("tickerSymbol", 52));
        rH.put(C0303k.MEDIA_FILE_TYPE, C0424a.m1284g(C0303k.MEDIA_FILE_TYPE, 53));
        rH.put(PlusShare.KEY_CALL_TO_ACTION_URL, C0424a.m1284g(PlusShare.KEY_CALL_TO_ACTION_URL, 54));
        rH.put(IM.WIDTH, C0424a.m1284g(IM.WIDTH, 55));
        rH.put("worstRating", C0424a.m1284g("worstRating", 56));
    }
    ...
    protected boolean m1937a(C0424a c0424a) {
        return this.rI.contains(Integer.valueOf(c0424a.bw()));
    }

    protected Object m1938b(C0424a c0424a) {
        switch (c0424a.bw()) {
    ...
    public boolean equals(Object obj) {
        ...
        for (C0424a c0424a : rH.values()) {
            if (m1937a(c0424a)) {
                if (!fqVar.m1937a(c0424a)) {
                    return false;
                }
                if (!m1938b(c0424a).equals(fqVar.m1938b(c0424a))) {
                    return false;
                }
            } else if (fqVar.m1937a(c0424a)) {
                return false;
            }
        }
        return true;
    ...
    public int hashCode() {
        ...
        for (C0424a c0424a : rH.values()) {
            int hashCode;
            if (m1937a(c0424a)) {
                hashCode = m1938b(c0424a).hashCode() + (i + c0424a.bw());
            } else {
                hashCode = i;
            }
            i = hashCode;
