...
public final class C0473x implements SafeParcelable {
    public static final C0165y CREATOR;
    ...
    C0473x(int i, String str, int i2, int i3, boolean z, int i4, int i5) {
        this.versionCode = i;
        this.ew = str;
        this.height = i2;
    ...
    public C0473x(Context context, AdSize adSize) {
        int i;
        int i2;
        int i3 = 1;
        this.versionCode = 1;
        ...
        if (i4 != 0) {
            this.widthPixels = C0473x.m1526a(displayMetrics);
        ...
        i2 = i3 != 0 ? C0473x.m1528c(displayMetrics) : this.height;
    ...
    public static int m1527b(DisplayMetrics displayMetrics) {
        return (int) (((float) C0473x.m1528c(displayMetrics)) * displayMetrics.density);
    }
