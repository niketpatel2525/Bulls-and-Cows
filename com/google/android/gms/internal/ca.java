...
public final class ca {
    ...
    private static void m235a(HashMap<String, Object> hashMap, cd cdVar) {
        ...
        if (!TextUtils.isEmpty(cdVar.hk)) {
            hashMap.put(C0300h.CARRIER, cdVar.hk);
        }
    ...
    private static void m236a(HashMap<String, Object> hashMap, C0472v c0472v) {
        if (c0472v.es != -1) {
            hashMap.put("cust_age", gS.format(new Date(c0472v.es)));
        }
        if (c0472v.extras != null) {
            hashMap.put("extras", c0472v.extras);
        }
        if (c0472v.et != -1) {
            hashMap.put("cust_gender", Integer.valueOf(c0472v.et));
        }
        if (c0472v.eu != null) {
            hashMap.put("kw", c0472v.eu);
        }
        if (c0472v.tagForChildDirectedTreatment != -1) {
            hashMap.put("tag_for_child_directed_treatment", Integer.valueOf(c0472v.tagForChildDirectedTreatment));
        }
        if (c0472v.ev) {
