...
public interface ay extends IInterface {
    ...
    public static abstract class C0387a extends Binder implements ay {

        /* renamed from: com.google.android.gms.internal.ay.a.a */
        private static class C0386a implements ay {
            private IBinder dG;
        ...
        public static ay m1164k(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof ay)) ? new C0386a(iBinder) : (ay) queryLocalInterface;
        }
