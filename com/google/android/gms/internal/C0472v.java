...
public final class C0472v implements SafeParcelable {
    public static final C0164w CREATOR;
    ...
    C0472v(int i, long j, Bundle bundle, int i2, List<String> list, boolean z, int i3) {
        this.versionCode = i;
        this.es = j;
        this.extras = bundle;
        this.et = i2;
    ...
    public C0472v(Context context, AdRequest adRequest) {
        Bundle bundle = null;
        this.versionCode = 1;
