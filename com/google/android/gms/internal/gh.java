...
import com.google.android.gms.internal.gi.C0465a;
...
public interface gh extends IInterface {
    ...
    public static abstract class C0463a extends Binder implements gh {

        /* renamed from: com.google.android.gms.internal.gh.a.a */
        private static class C0462a implements gh {
            private IBinder dG;
        ...
        public static gh as(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof gh)) ? new C0462a(iBinder) : (gh) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case DetectedActivity.ON_BICYCLE /*1*/:
                    ...
                    m643a(data.readInt() != 0 ? (MaskedWalletRequest) MaskedWalletRequest.CREATOR.createFromParcel(data) : null, data.readInt() != 0 ? (Bundle) Bundle.CREATOR.createFromParcel(data) : null, C0465a.at(data.readStrongBinder()));
                    return true;
                case DetectedActivity.ON_FOOT /*2*/:
                    data.enforceInterface("com.google.android.gms.wallet.internal.IOwService");
                    m642a(data.readInt() != 0 ? (FullWalletRequest) FullWalletRequest.CREATOR.createFromParcel(data) : null, data.readInt() != 0 ? (Bundle) Bundle.CREATOR.createFromParcel(data) : null, C0465a.at(data.readStrongBinder()));
                    return true;
                case DetectedActivity.STILL /*3*/:
                    data.enforceInterface("com.google.android.gms.wallet.internal.IOwService");
                    m645a(data.readString(), data.readString(), data.readInt() != 0 ? (Bundle) Bundle.CREATOR.createFromParcel(data) : null, C0465a.at(data.readStrongBinder()));
                    return true;
                ...
                case DetectedActivity.TILTING /*5*/:
                    data.enforceInterface("com.google.android.gms.wallet.internal.IOwService");
                    m641a(data.readInt() != 0 ? (Bundle) Bundle.CREATOR.createFromParcel(data) : null, C0465a.at(data.readStrongBinder()));
                    return true;
                case 1598968902:
