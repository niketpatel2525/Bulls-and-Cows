...
public final class bz extends C0406a {
    ...
    static class C01121 implements Runnable {
        ...
        C01121(Context context, bu buVar, cb cbVar, String str) {
            this.gO = context;
            this.gP = buVar;
            this.gQ = cbVar;
            this.gR = str;
        ...
        public void run() {
            cq a = cq.m303a(this.gO, new C0473x(), false, false, null, this.gP.eg);
    ...
    private static bw m1805a(Context context, al alVar, bu buVar) {
        ...
        cm.hO.post(new C01121(context, buVar, cbVar, a));
        a = cbVar.aj();
