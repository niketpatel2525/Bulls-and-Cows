...
public class es {
    ...
    public static final class C0143a {
        ...
        private C0143a(int i, IBinder iBinder) {
            this.nr = -1;
            this.left = 0;
            this.top = 0;
            this.right = 0;
    ...
    private static final class C0439b extends es implements OnAttachStateChangeListener, OnGlobalLayoutListener {
        private boolean mK;
        private WeakReference<View> ns;

        protected C0439b(em emVar, int i) {
            super(i, null);
            this.mK = false;
        }
    ...
    public static es m568a(em emVar, int i) {
        return ek.bK() ? new C0439b(emVar, i) : new es(emVar, i);
    }

    protected void m569Q(int i) {
        this.np = new C0143a(new Binder(), null);
    }
