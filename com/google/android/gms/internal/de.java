...
import com.google.android.gms.internal.dj.C0420a;
...
public abstract class de<T extends IInterface> implements GooglePlayServicesClient {
    ...
    private boolean kI;
    private final ArrayList<C0134b<?>> kJ;
    private C0135e kK;
    boolean kL;
    boolean kM;
    ...
    final class C0133a extends Handler {
        final /* synthetic */ de kP;

        public C0133a(de deVar, Looper looper) {
            this.kP = deVar;
            super(looper);
        }
    ...
    protected abstract class C0134b<TListener> {
        final /* synthetic */ de kP;
        private boolean kQ;
        private TListener mListener;

        public C0134b(de deVar, TListener tListener) {
            this.kP = deVar;
    ...
    final class C0135e implements ServiceConnection {
        final /* synthetic */ de kP;
    ...
    public abstract class C0415c<TListener> extends C0134b<TListener> {
        private final C0348d jf;
        final /* synthetic */ de kP;

        public C0415c(de deVar, TListener tListener, C0348d c0348d) {
            this.kP = deVar;
        ...
        protected abstract void m1230a(TListener tListener, C0348d c0348d);
    ...
    protected final class C0416f extends C0134b<Boolean> {
        final /* synthetic */ de kP;
        public final Bundle kS;
        public final IBinder kT;
        public final int statusCode;

        public C0416f(de deVar, int i, IBinder iBinder, Bundle bundle) {
            this.kP = deVar;
    ...
    public static final class C0582d extends C0418a {
        private de kR;

        public C0582d(de deVar) {
            this.kR = deVar;
        }
    ...
    protected de(Context context, ConnectionCallbacks connectionCallbacks, OnConnectionFailedListener onConnectionFailedListener, String... strArr) {
        ...
        this.mHandler = new C0133a(this, context.getMainLooper());
        m1245a(strArr);
        this.is = strArr;
    }

    protected void m1241a(int i, IBinder iBinder, Bundle bundle) {
        this.mHandler.sendMessage(this.mHandler.obtainMessage(1, new C0416f(this, i, iBinder, bundle)));
    }
    ...
    public final void m1243a(C0134b<?> c0134b) {
        synchronized (this.kJ) {
            this.kJ.add(c0134b);
        }
        this.mHandler.sendMessage(this.mHandler.obtainMessage(2, c0134b));
    }

    protected abstract void m1244a(dj djVar, C0582d c0582d) throws RemoteException;
    ...
    protected final void m1247u(IBinder iBinder) {
        try {
            m1244a(C0420a.m1265w(iBinder), new C0582d(this));
        } catch (RemoteException e) {
