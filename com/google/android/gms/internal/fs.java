...
public final class fs extends dw implements SafeParcelable, Moment {
    ...
    static {
        CREATOR = new ft();
        rH = new HashMap();
        rH.put(C0303k.ID, C0424a.m1284g(C0303k.ID, 2));
        rH.put("result", C0424a.m1278a("result", 4, fq.class));
        rH.put("startDate", C0424a.m1284g("startDate", 5));
        rH.put("target", C0424a.m1278a("target", 6, fq.class));
        rH.put(C0303k.MEDIA_FILE_TYPE, C0424a.m1284g(C0303k.MEDIA_FILE_TYPE, 7));
    }
    ...
    protected boolean m1942a(C0424a c0424a) {
        return this.rI.contains(Integer.valueOf(c0424a.bw()));
    }

    protected Object m1943b(C0424a c0424a) {
        switch (c0424a.bw()) {
    ...
    public boolean equals(Object obj) {
        ...
        for (C0424a c0424a : rH.values()) {
            if (m1942a(c0424a)) {
                if (!fsVar.m1942a(c0424a)) {
                    return false;
                }
                if (!m1943b(c0424a).equals(fsVar.m1943b(c0424a))) {
                    return false;
                }
            } else if (fsVar.m1942a(c0424a)) {
                return false;
            }
        }
        return true;
    ...
    public int hashCode() {
        ...
        for (C0424a c0424a : rH.values()) {
            int hashCode;
            if (m1942a(c0424a)) {
                hashCode = m1943b(c0424a).hashCode() + (i + c0424a.bw());
            } else {
                hashCode = i;
            }
            i = hashCode;
