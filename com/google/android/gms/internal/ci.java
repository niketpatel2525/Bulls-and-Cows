...
public final class ci {
    ...
    static class C01171 implements Runnable {
    ...
    private static final class C0118a extends BroadcastReceiver {
        private C0118a() {
        }
    ...
    public static boolean m270h(Context context) {
        ...
        if ((resolveActivity.activityInfo.configChanges & AccessibilityNodeInfoCompat.ACTION_NEXT_HTML_ELEMENT) == 0) {
            cn.m299q(String.format(str, new Object[]{C0300h.SCREEN_SIZE}));
            z = false;
        }
    ...
    public static void m272i(Context context) {
        if (!hL) {
            ...
            context.getApplicationContext().registerReceiver(new C0118a(), intentFilter);
            hL = true;
        }
    }
