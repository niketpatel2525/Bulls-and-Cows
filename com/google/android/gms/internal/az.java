...
import com.google.android.gms.internal.ax.C0385a;
import java.util.HashMap;
import java.util.Iterator;
import java.util.Map;
import org.json.JSONObject;

public final class az<NETWORK_EXTRAS extends NetworkExtras, SERVER_PARAMETERS extends MediationServerParameters> extends C0385a {
    ...
    public void m1788a(C0070b c0070b, C0472v c0472v, String str, ay ayVar) throws RemoteException {
        if (this.fr instanceof MediationInterstitialAdapter) {
            cn.m295m("Requesting interstitial ad from adapter.");
            try {
                ((MediationInterstitialAdapter) this.fr).requestInterstitialAd(new ba(ayVar), (Activity) C0569c.m1772b(c0070b), m1787a(str, c0472v.tagForChildDirectedTreatment), bb.m197e(c0472v), this.fs);
            } catch (Throwable th) {
    ...
    public void m1789a(C0070b c0070b, C0473x c0473x, C0472v c0472v, String str, ay ayVar) throws RemoteException {
        if (this.fr instanceof MediationBannerAdapter) {
            cn.m295m("Requesting banner ad from adapter.");
            try {
                ((MediationBannerAdapter) this.fr).requestBannerAd(new ba(ayVar), (Activity) C0569c.m1772b(c0070b), m1787a(str, c0472v.tagForChildDirectedTreatment), bb.m195a(c0473x), bb.m197e(c0472v), this.fs);
            } catch (Throwable th) {
    ...
    public C0070b getView() throws RemoteException {
        if (this.fr instanceof MediationBannerAdapter) {
            try {
                return C0569c.m1773g(((MediationBannerAdapter) this.fr).getBannerView());
            } catch (Throwable th) {
