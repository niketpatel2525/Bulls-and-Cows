...
public final class cb {
    ...
    class C04071 implements ai {
        ...
        public void m1208a(cq cqVar, Map<String, String> map) {
            synchronized (this.gW.eJ) {
                ...
                cn.m299q("Invalid " + ((String) map.get(C0303k.MEDIA_FILE_TYPE)) + " request error: " + str);
                this.gW.gw = 1;
                this.gW.eJ.notify();
            }
        }
    ...
    public cb() {
        this.eJ = new Object();
        this.gw = -2;
        this.gU = new C04071(this);
        this.gV = new C04082(this);
    }
