...
public class cs extends WebChromeClient {
    ...
    static class C01211 implements OnCancelListener {
        final /* synthetic */ JsResult ii;

        C01211(JsResult jsResult) {
            this.ii = jsResult;
        }
    ...
    static class C01222 implements OnClickListener {
        final /* synthetic */ JsResult ii;

        C01222(JsResult jsResult) {
            this.ii = jsResult;
        }
    ...
    static class C01233 implements OnClickListener {
        final /* synthetic */ JsResult ii;

        C01233(JsResult jsResult) {
            this.ii = jsResult;
        }
    ...
    static class C01244 implements OnCancelListener {
        final /* synthetic */ JsPromptResult ij;

        C01244(JsPromptResult jsPromptResult) {
    ...
    static class C01255 implements OnClickListener {
        final /* synthetic */ JsPromptResult ij;

        C01255(JsPromptResult jsPromptResult) {
            this.ij = jsPromptResult;
        }
    ...
    static class C01266 implements OnClickListener {
        final /* synthetic */ JsPromptResult ij;
        final /* synthetic */ EditText ik;

        C01266(JsPromptResult jsPromptResult, EditText editText) {
            this.ij = jsPromptResult;
            this.ik = editText;
        }
    ...
    private static void m321a(Builder builder, String str, JsResult jsResult) {
        builder.setMessage(str).setPositiveButton(17039370, new C01233(jsResult)).setNegativeButton(17039360, new C01222(jsResult)).setOnCancelListener(new C01211(jsResult)).create().show();
    }
    ...
    private static void m322a(Context context, Builder builder, String str, String str2, JsPromptResult jsPromptResult) {
        ...
        builder.setView(linearLayout).setPositiveButton(17039370, new C01266(jsPromptResult, editText)).setNegativeButton(17039360, new C01255(jsPromptResult)).setOnCancelListener(new C01244(jsPromptResult)).create().show();
    }
    ...
    public final boolean onConsoleMessage(ConsoleMessage consoleMessage) {
        ...
        switch (C01277.il[consoleMessage.messageLevel().ordinal()]) {
