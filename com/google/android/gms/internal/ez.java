...
import com.google.android.gms.internal.ew.C0441a;
import com.google.android.gms.internal.ex.C0443a;
...
public class ez extends de<ex> {
    ...
    private final class C0444a extends C0134b<OnAddGeofencesResultListener> {
        private final int iC;
        private final String[] oW;
        final /* synthetic */ ez oX;

        public C0444a(ez ezVar, OnAddGeofencesResultListener onAddGeofencesResultListener, int i, String[] strArr) {
            this.oX = ezVar;
    ...
    private final class C0445c implements fc<ex> {
        final /* synthetic */ ez oX;

        private C0445c(ez ezVar) {
            this.oX = ezVar;
        }
    ...
    private final class C0446d extends C0134b<OnRemoveGeofencesResultListener> {
        private final int iC;
        ...
        public C0446d(ez ezVar, int i, OnRemoveGeofencesResultListener onRemoveGeofencesResultListener, int i2, PendingIntent pendingIntent) {
            boolean z = true;
            this.oX = ezVar;
        ...
        public C0446d(ez ezVar, int i, OnRemoveGeofencesResultListener onRemoveGeofencesResultListener, int i2, String[] strArr) {
            this.oX = ezVar;
            super(ezVar, onRemoveGeofencesResultListener);
            db.m343k(i == 2);
            this.pb = i;
    ...
    private static final class C0590b extends C0441a {
        private OnAddGeofencesResultListener oY;
        private OnRemoveGeofencesResultListener oZ;
        private ez pa;

        public C0590b(OnAddGeofencesResultListener onAddGeofencesResultListener, ez ezVar) {
            this.oY = onAddGeofencesResultListener;
            this.oZ = null;
            this.pa = ezVar;
        }

        public C0590b(OnRemoveGeofencesResultListener onRemoveGeofencesResultListener, ez ezVar) {
        ...
        public void onAddGeofencesResult(int statusCode, String[] geofenceRequestIds) throws RemoteException {
            ...
            ez ezVar2 = this.pa;
            ezVar2.getClass();
            ezVar.m1243a(new C0444a(ezVar2, this.oY, statusCode, geofenceRequestIds));
            this.pa = null;
            this.oY = null;
            this.oZ = null;
        }
        ...
        public void onRemoveGeofencesByPendingIntentResult(int statusCode, PendingIntent pendingIntent) {
            ...
            ez ezVar2 = this.pa;
            ezVar2.getClass();
            ezVar.m1243a(new C0446d(ezVar2, 1, this.oZ, statusCode, pendingIntent));
            this.pa = null;
            this.oY = null;
            this.oZ = null;
        }
        ...
        public void onRemoveGeofencesByRequestIdsResult(int statusCode, String[] geofenceRequestIds) {
            ...
            ez ezVar2 = this.pa;
            ezVar2.getClass();
            ezVar.m1243a(new C0446d(ezVar2, 2, this.oZ, statusCode, geofenceRequestIds));
            this.pa = null;
            this.oY = null;
            this.oZ = null;
        }
    ...
    protected ex m1897G(IBinder iBinder) {
        return C0443a.m1466F(iBinder);
    }

    protected void m1898a(dj djVar, C0582d c0582d) throws RemoteException {
        Bundle bundle = new Bundle();
        bundle.putString("client_name", this.oV);
        djVar.m379e(c0582d, GooglePlayServicesUtil.GOOGLE_PLAY_SERVICES_VERSION_CODE, getContext().getPackageName(), bundle);
    }
    ...
    public void addGeofences(List<fa> geofences, PendingIntent pendingIntent, OnAddGeofencesResultListener listener) {
        ...
        if (listener == null) {
            ...
            Object c0590b = new C0590b(listener, this);
        }
        try {
