...
import com.google.android.gms.internal.at.C0086a;

public final class as implements C0086a {
    private final aw dZ;
    private final Object eJ;
    private final C0472v em;
    private final String fd;
    private final long fe;
    private final ao ff;
    private final C0473x fg;
    private ax fh;
    private int fi;
    ...
    public as(Context context, String str, aw awVar, ap apVar, ao aoVar, C0472v c0472v, C0473x c0473x) {
        this.eJ = new Object();
        this.fi = -2;
    ...
    private void m1150a(ar arVar) {
        try {
            if (this.fg.ex) {
                this.fh.m188a(C0569c.m1773g(this.mContext), this.em, this.ff.eS, arVar);
            } else {
                this.fh.m189a(C0569c.m1773g(this.mContext), this.fg, this.em, this.ff.eS, arVar);
            }
        } catch (Throwable e) {
    ...
    public at m1156b(long j, long j2) {
        ...
        synchronized (this.eJ) {
            long elapsedRealtime = SystemClock.elapsedRealtime();
            ar arVar = new ar();
            cm.hO.post(new C00851(this, arVar));
