...
import com.google.android.gms.internal.cx.C0412a;

public interface cy extends IInterface {

    /* renamed from: com.google.android.gms.internal.cy.a */
    public static abstract class C0414a extends Binder implements cy {

        /* renamed from: com.google.android.gms.internal.cy.a.a */
        private static class C0413a implements cy {
            private IBinder dG;
        ...
        public static cy m1226t(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof cy)) ? new C0413a(iBinder) : (cy) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 5003:
                    data.enforceInterface("com.google.android.gms.appstate.internal.IAppStateService");
                    m331a(C0412a.m1218s(data.readStrongBinder()), data.readInt(), data.createByteArray());
                    reply.writeNoException();
                    return true;
                case 5004:
                    data.enforceInterface("com.google.android.gms.appstate.internal.IAppStateService");
                    m329a(C0412a.m1218s(data.readStrongBinder()), data.readInt());
                    reply.writeNoException();
                    return true;
                case 5005:
                    data.enforceInterface("com.google.android.gms.appstate.internal.IAppStateService");
                    m328a(C0412a.m1218s(data.readStrongBinder()));
                    reply.writeNoException();
                    return true;
                case 5006:
                    data.enforceInterface("com.google.android.gms.appstate.internal.IAppStateService");
                    m330a(C0412a.m1218s(data.readStrongBinder()), data.readInt(), data.readString(), data.createByteArray());
                    reply.writeNoException();
                    return true;
                case 5007:
                    data.enforceInterface("com.google.android.gms.appstate.internal.IAppStateService");
                    m333b(C0412a.m1218s(data.readStrongBinder()), data.readInt());
                    reply.writeNoException();
                    return true;
                case 5008:
                    data.enforceInterface("com.google.android.gms.appstate.internal.IAppStateService");
                    m332b(C0412a.m1218s(data.readStrongBinder()));
                    reply.writeNoException();
                    return true;
                case 5009:
                    data.enforceInterface("com.google.android.gms.appstate.internal.IAppStateService");
                    m334c(C0412a.m1218s(data.readStrongBinder()));
                    reply.writeNoException();
                    return true;
                case 1598968902:
