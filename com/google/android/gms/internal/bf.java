...
public final class bf extends C0402a {
    ...
    private static final class C0100a extends Exception {
    ...
    private static final class C0101b {
        ...
        public C0101b(cq cqVar) throws C0100a {
            ...
            throw new C0100a("Could not get the parent of the WebView for an overlay.");
        }
    }

    /* renamed from: com.google.android.gms.internal.bf.1 */
    class C04001 implements C0120a {
    ...
    private void m1793e(boolean z) throws C0100a {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            if (this.fE == null) {
                throw new C0100a("Could not get info for ad overlay.");
            }
            if (savedInstanceState == null) {
                if (this.fE.fT != null) {
                    this.fE.fT.m207C();
            ...
            switch (this.fE.ga) {
                ...
                default:
                    throw new C0100a("Could not determine ad overlay type.");
            }
        } catch (C0100a e) {
