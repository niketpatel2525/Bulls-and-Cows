...
public class fr implements Creator<fq> {
    static void m617a(fq fqVar, Parcel parcel, int i) {
        ...
        if (di.contains(Integer.valueOf(1))) {
            C0066b.m131c(parcel, 1, fqVar.getVersionCode());
        }
        if (di.contains(Integer.valueOf(2))) {
            C0066b.m120a(parcel, 2, fqVar.dj(), i, true);
        }
        if (di.contains(Integer.valueOf(3))) {
            C0066b.m122a(parcel, 3, fqVar.getAdditionalName(), true);
        }
        if (di.contains(Integer.valueOf(4))) {
            C0066b.m120a(parcel, 4, fqVar.dk(), i, true);
        }
        if (di.contains(Integer.valueOf(5))) {
            C0066b.m121a(parcel, 5, fqVar.getAddressCountry(), true);
        }
        if (di.contains(Integer.valueOf(6))) {
            C0066b.m121a(parcel, 6, fqVar.getAddressLocality(), true);
        }
        if (di.contains(Integer.valueOf(7))) {
            C0066b.m121a(parcel, 7, fqVar.getAddressRegion(), true);
        }
        if (di.contains(Integer.valueOf(8))) {
            C0066b.m130b(parcel, 8, fqVar.dl(), true);
        }
        if (di.contains(Integer.valueOf(9))) {
            C0066b.m131c(parcel, 9, fqVar.getAttendeeCount());
        }
        if (di.contains(Integer.valueOf(10))) {
            C0066b.m130b(parcel, 10, fqVar.dm(), true);
        }
        if (di.contains(Integer.valueOf(11))) {
            C0066b.m120a(parcel, 11, fqVar.dn(), i, true);
        }
        if (di.contains(Integer.valueOf(12))) {
            C0066b.m130b(parcel, 12, fqVar.m1939do(), true);
        }
        if (di.contains(Integer.valueOf(13))) {
            C0066b.m121a(parcel, 13, fqVar.getBestRating(), true);
        }
        if (di.contains(Integer.valueOf(14))) {
            C0066b.m121a(parcel, 14, fqVar.getBirthDate(), true);
        }
        if (di.contains(Integer.valueOf(15))) {
            C0066b.m120a(parcel, 15, fqVar.dp(), i, true);
        }
        if (di.contains(Integer.valueOf(17))) {
            C0066b.m121a(parcel, 17, fqVar.getContentSize(), true);
        }
        if (di.contains(Integer.valueOf(16))) {
            C0066b.m121a(parcel, 16, fqVar.getCaption(), true);
        }
        if (di.contains(Integer.valueOf(19))) {
            C0066b.m130b(parcel, 19, fqVar.dq(), true);
        }
        if (di.contains(Integer.valueOf(18))) {
            C0066b.m121a(parcel, 18, fqVar.getContentUrl(), true);
        }
        if (di.contains(Integer.valueOf(21))) {
            C0066b.m121a(parcel, 21, fqVar.getDateModified(), true);
        }
        if (di.contains(Integer.valueOf(20))) {
            C0066b.m121a(parcel, 20, fqVar.getDateCreated(), true);
        }
        if (di.contains(Integer.valueOf(23))) {
            C0066b.m121a(parcel, 23, fqVar.getDescription(), true);
        }
        if (di.contains(Integer.valueOf(22))) {
            C0066b.m121a(parcel, 22, fqVar.getDatePublished(), true);
        }
        if (di.contains(Integer.valueOf(25))) {
            C0066b.m121a(parcel, 25, fqVar.getEmbedUrl(), true);
        }
        if (di.contains(Integer.valueOf(24))) {
            C0066b.m121a(parcel, 24, fqVar.getDuration(), true);
        }
        if (di.contains(Integer.valueOf(27))) {
            C0066b.m121a(parcel, 27, fqVar.getFamilyName(), true);
        }
        if (di.contains(Integer.valueOf(26))) {
            C0066b.m121a(parcel, 26, fqVar.getEndDate(), true);
        }
        if (di.contains(Integer.valueOf(29))) {
            C0066b.m120a(parcel, 29, fqVar.dr(), i, true);
        }
        if (di.contains(Integer.valueOf(28))) {
            C0066b.m121a(parcel, 28, fqVar.getGender(), true);
        }
        if (di.contains(Integer.valueOf(31))) {
            C0066b.m121a(parcel, 31, fqVar.getHeight(), true);
        }
        if (di.contains(Integer.valueOf(30))) {
            C0066b.m121a(parcel, 30, fqVar.getGivenName(), true);
        }
        if (di.contains(Integer.valueOf(34))) {
            C0066b.m120a(parcel, 34, fqVar.ds(), i, true);
        }
        if (di.contains(Integer.valueOf(32))) {
            C0066b.m121a(parcel, 32, fqVar.getId(), true);
        }
        if (di.contains(Integer.valueOf(33))) {
            C0066b.m121a(parcel, 33, fqVar.getImage(), true);
        }
        if (di.contains(Integer.valueOf(38))) {
            C0066b.m114a(parcel, 38, fqVar.getLongitude());
        }
        if (di.contains(Integer.valueOf(39))) {
            C0066b.m121a(parcel, 39, fqVar.getName(), true);
        }
        if (di.contains(Integer.valueOf(36))) {
            C0066b.m114a(parcel, 36, fqVar.getLatitude());
        }
        if (di.contains(Integer.valueOf(37))) {
            C0066b.m120a(parcel, 37, fqVar.dt(), i, true);
        }
        if (di.contains(Integer.valueOf(42))) {
            C0066b.m121a(parcel, 42, fqVar.getPlayerType(), true);
        }
        if (di.contains(Integer.valueOf(43))) {
            C0066b.m121a(parcel, 43, fqVar.getPostOfficeBoxNumber(), true);
        }
        if (di.contains(Integer.valueOf(40))) {
            C0066b.m120a(parcel, 40, fqVar.du(), i, true);
        }
        if (di.contains(Integer.valueOf(41))) {
            C0066b.m130b(parcel, 41, fqVar.dv(), true);
        }
        if (di.contains(Integer.valueOf(46))) {
            C0066b.m120a(parcel, 46, fqVar.dw(), i, true);
        }
        if (di.contains(Integer.valueOf(47))) {
            C0066b.m121a(parcel, 47, fqVar.getStartDate(), true);
        }
        if (di.contains(Integer.valueOf(44))) {
            C0066b.m121a(parcel, 44, fqVar.getPostalCode(), true);
        }
        if (di.contains(Integer.valueOf(45))) {
            C0066b.m121a(parcel, 45, fqVar.getRatingValue(), true);
        }
        if (di.contains(Integer.valueOf(51))) {
            C0066b.m121a(parcel, 51, fqVar.getThumbnailUrl(), true);
        }
        if (di.contains(Integer.valueOf(50))) {
            C0066b.m120a(parcel, 50, fqVar.dx(), i, true);
        }
        if (di.contains(Integer.valueOf(49))) {
            C0066b.m121a(parcel, 49, fqVar.getText(), true);
        }
        if (di.contains(Integer.valueOf(48))) {
            C0066b.m121a(parcel, 48, fqVar.getStreetAddress(), true);
        }
        if (di.contains(Integer.valueOf(55))) {
            C0066b.m121a(parcel, 55, fqVar.getWidth(), true);
        }
        if (di.contains(Integer.valueOf(54))) {
            C0066b.m121a(parcel, 54, fqVar.getUrl(), true);
        }
        if (di.contains(Integer.valueOf(53))) {
            C0066b.m121a(parcel, 53, fqVar.getType(), true);
        }
        if (di.contains(Integer.valueOf(52))) {
            C0066b.m121a(parcel, 52, fqVar.getTickerSymbol(), true);
        }
        if (di.contains(Integer.valueOf(56))) {
            C0066b.m121a(parcel, 56, fqVar.getWorstRating(), true);
        }
