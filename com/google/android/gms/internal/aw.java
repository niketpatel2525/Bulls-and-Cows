...
public interface aw extends IInterface {
    ...
    public static abstract class C0383a extends Binder implements aw {

        /* renamed from: com.google.android.gms.internal.aw.a.a */
        private static class C0382a implements aw {
            private IBinder dG;
            ...
            public ax m1158g(String str) throws RemoteException {
                ...
                try {
                    ...
                    ax j = C0385a.m1162j(obtain2.readStrongBinder());
                    return j;
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
        ...
        public static aw m1159i(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof aw)) ? new C0382a(iBinder) : (aw) queryLocalInterface;
        }
