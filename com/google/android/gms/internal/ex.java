...
public interface ex extends IInterface {
    ...
    public static abstract class C0443a extends Binder implements ex {

        /* renamed from: com.google.android.gms.internal.ex.a.a */
        private static class C0442a implements ex {
            private IBinder dG;
            ...
            public void m1461a(LocationRequest locationRequest, C0166a c0166a) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.location.internal.IGoogleLocationManagerService");
                    ...
                    obtain.writeStrongBinder(c0166a != null ? c0166a.asBinder() : null);
            ...
            public void m1462a(LocationRequest locationRequest, C0166a c0166a, String str) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.location.internal.IGoogleLocationManagerService");
            ...
            public void m1463a(C0166a c0166a) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.location.internal.IGoogleLocationManagerService");
        ...
        public static ex m1466F(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof ex)) ? new C0442a(iBinder) : (ex) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                case DetectedActivity.ON_BICYCLE /*1*/:
                    ...
                    m581a(createTypedArrayList, pendingIntent, C0441a.m1455E(data.readStrongBinder()), data.readString());
                ...
                case DetectedActivity.ON_FOOT /*2*/:
                    ...
                    m575a(pendingIntent, C0441a.m1455E(data.readStrongBinder()), data.readString());
                    reply.writeNoException();
                    return true;
                case DetectedActivity.STILL /*3*/:
                    data.enforceInterface("com.google.android.gms.location.internal.IGoogleLocationManagerService");
                    m582a(data.createStringArray(), C0441a.m1455E(data.readStrongBinder()), data.readString());
                    reply.writeNoException();
                    return true;
                case DetectedActivity.UNKNOWN /*4*/:
                    data.enforceInterface("com.google.android.gms.location.internal.IGoogleLocationManagerService");
                    m576a(C0441a.m1455E(data.readStrongBinder()), data.readString());
                    reply.writeNoException();
                    return true;
                ...
                case GamesClient.STATUS_APP_MISCONFIGURED /*8*/:
                    ...
                    m578a(locationRequest, C0475a.m1534D(data.readStrongBinder()));
                    reply.writeNoException();
                    return true;
                ...
                case ConnectionResult.DEVELOPER_ERROR /*10*/:
                    data.enforceInterface("com.google.android.gms.location.internal.IGoogleLocationManagerService");
                    m580a(C0475a.m1534D(data.readStrongBinder()));
                    reply.writeNoException();
                    return true;
                ...
                case 20:
                    ...
                    m579a(locationRequest, C0475a.m1534D(data.readStrongBinder()), data.readString());
                    reply.writeNoException();
                    return true;
                case 1598968902:
    ...
    void m578a(LocationRequest locationRequest, C0166a c0166a) throws RemoteException;

    void m579a(LocationRequest locationRequest, C0166a c0166a, String str) throws RemoteException;

    void m580a(C0166a c0166a) throws RemoteException;
