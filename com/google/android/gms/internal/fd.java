...
public interface fd extends IInterface {
    ...
    public static abstract class C0448a extends Binder implements fd {

        /* renamed from: com.google.android.gms.internal.fd.a.a */
        private static class C0447a implements fd {
            private IBinder dG;
        ...
        public static fd ak(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof fd)) ? new C0447a(iBinder) : (fd) queryLocalInterface;
        }
